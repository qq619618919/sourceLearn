...
public class StreamExecSink extends CommonExecSink implements StreamExecNode<Object> {
    ...
    public StreamExecSink(DynamicTableSinkSpec tableSinkSpec,
                          ChangelogMode inputChangelogMode,
                          InputProperty inputProperty,
                          LogicalType outputType,
                          boolean upsertMaterialize,
                          String description) {
        super(tableSinkSpec, tableSinkSpec.getTableSink().getChangelogMode(inputChangelogMode), false, // isBounded
                getNewNodeId(), Collections.singletonList(inputProperty), outputType, description
        );
    ...
    @JsonCreator
    public StreamExecSink(@JsonProperty(FIELD_NAME_DYNAMIC_TABLE_SINK) DynamicTableSinkSpec tableSinkSpec,
        ...
        super(tableSinkSpec, tableSinkSpec.getTableSink().getChangelogMode(inputChangelogMode), false, // isBounded
                id, inputProperties, outputType, description
        );
        this.inputChangelogMode = inputChangelogMode;
        this.upsertMaterialize = upsertMaterialize;
    }
    ...
    protected Transformation<Object> translateToPlanInternal(PlannerBase planner) {
        ...
        return createSinkTransformation(planner.getExecEnv(),
