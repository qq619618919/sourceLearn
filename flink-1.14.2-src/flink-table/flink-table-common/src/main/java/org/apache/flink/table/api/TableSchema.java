...
public class TableSchema {
    ...
    private TableSchema(List<TableColumn> columns,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(columns, that.columns) && Objects.equals(watermarkSpecs, that.watermarkSpecs)
    ...
    public static TableSchema fromResolvedSchema(ResolvedSchema resolvedSchema) {
        ...
        resolvedSchema.getColumns().stream().map(column -> {
            if (column instanceof Column.PhysicalColumn) {
                ...
                return TableColumn.metadata(c.getName(),
                        c.getDataType(),
        ...
        resolvedSchema
                .getWatermarkSpecs()
                .forEach(spec -> builder.watermark(spec.getRowtimeAttribute(),
        ...
        resolvedSchema
                .getPrimaryKey()
                .ifPresent(pk -> builder.primaryKey(pk.getName(), pk.getColumns().toArray(new String[0])));
        ...
        if (fieldNames.length != fieldTypes.length) {
            throw new ValidationException(
                    "Number of field names and field data types must be equal.\n" + "Number of names is "
                            + fieldNames.length + ", number of data types is " + fieldTypes.length + ".\n"
    ...
    private static void validateColumnsAndWatermarkSpecs(List<TableColumn> columns,
        ...
        for (WatermarkSpec watermark : watermarkSpecs) {
            ...
            LogicalType rowtimeType = Optional
                    .ofNullable(fieldNameToType.get(rowtimeAttribute))
    ...
    private static void validatePrimaryKey(List<TableColumn> columns, UniqueConstraint primaryKey) {
        Map<String, TableColumn> columnsByNameLookup = columns
                .stream()
     ...
     */
    private static void validateAndCreateNameToTypeMapping(Map<String, LogicalType> fieldNameToType,
                                                           String fieldName,
        ...
        if (isCompositeType(fieldType) && !(fieldType instanceof LegacyTypeInformationType)) {
            ...
            IntStream
                    ...
                    .forEach(i -> validateAndCreateNameToTypeMapping(fieldNameToType,
                            fieldNames.get(i),
                            fieldTypes.get(i),
                            fullFieldName
                    ));
    ...
    public static class Builder {
        ...
        public Builder fields(String[] names, DataType[] dataTypes) {
            ...
            List<TableColumn> columns = IntStream
        ...
        public Builder watermark(String rowtimeAttribute,
            ...
            this.watermarkSpecs.add(new WatermarkSpec(rowtimeAttribute,
