...
public class AkkaRpcSystem implements RpcSystem {
    ...
    @Override
    public RpcServiceBuilder remoteServiceBuilder(Configuration configuration,
    ...
    @Override
    public String getRpcUrl(String hostname,
                            int port,
                            String endpointName,
                            AddressResolution addressResolution,
                            Configuration config) throws UnknownHostException {
        return AkkaRpcServiceUtils.getRpcUrl(hostname, port, endpointName, addressResolution, config);
    }
