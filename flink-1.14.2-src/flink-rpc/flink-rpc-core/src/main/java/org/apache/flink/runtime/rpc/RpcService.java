...
/**
 * // TODO_MA 马中华 注释： rpc 服务的接口。
 * Interface for rpc services.
 *
 * // TODO_MA 马中华 注释： rpc 服务用于启动并连接到 {@link RpcEndpoint}。
 * An rpc service is used to start and connect to a {@link RpcEndpoint}.
 *
 * // TODO_MA 马中华 注释： 连接到 rpc 服务器将返回一个 {@link RpcGateway} 可用于调用远程过程。
 * Connecting to a rpc server will return a {@link RpcGateway} which can be used to call remote procedures.
 */
public interface RpcService {
     ...
     *  // TODO_MA 马中华 注释： xxxGateway.xyz()  = 发送 RPC 请求
     */
