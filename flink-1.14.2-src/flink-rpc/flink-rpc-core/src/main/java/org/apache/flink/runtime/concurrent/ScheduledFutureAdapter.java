...
public class ScheduledFutureAdapter<V> implements ScheduledFuture<V> {
    ...
    public ScheduledFutureAdapter(@Nonnull Future<V> delegate, long delay, @Nonnull TimeUnit timeUnit) {
        this(delegate,
    ...
    @VisibleForTesting
    ScheduledFutureAdapter(@Nonnull Future<V> delegate, long scheduleTimeNanos, long tieBreakerUid) {
