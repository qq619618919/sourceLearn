...
public class HBaseDynamicTableSource extends AbstractHBaseDynamicTableSource {
    ...
    public HBaseDynamicTableSource(Configuration conf,
                                   String tableName,
    ...
    public LookupRuntimeProvider getLookupRuntimeProvider(LookupContext context) {
        ...
        checkArgument(hbaseSchema.getRowKeyName().isPresent(),
                "HBase schema must have a row key when used in lookup mode."
        );
        checkArgument(hbaseSchema
        ...
        if (lookupOptions.getLookupAsync()) {
            return AsyncTableFunctionProvider.of(new HBaseRowDataAsyncLookupFunction(conf,
                    tableName,
                    hbaseSchema,
                    nullStringLiteral,
                    lookupOptions
