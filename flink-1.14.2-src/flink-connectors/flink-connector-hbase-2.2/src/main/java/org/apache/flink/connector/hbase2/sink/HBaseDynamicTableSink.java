...
public class HBaseDynamicTableSink implements DynamicTableSink {
    ...
    public HBaseDynamicTableSink(String tableName,
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        HBaseSinkFunction<RowData> sinkFunction = new HBaseSinkFunction<>(tableName,
                hbaseConf,
    ...
    public DynamicTableSink copy() {
        return new HBaseDynamicTableSink(tableName, hbaseTableSchema, hbaseConf, writeOptions, nullStringLiteral);
    }
