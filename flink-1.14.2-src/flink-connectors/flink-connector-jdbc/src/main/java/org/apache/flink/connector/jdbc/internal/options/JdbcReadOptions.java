...
public class JdbcReadOptions implements Serializable {
    ...
    private JdbcReadOptions(String query,
    ...
    public boolean equals(Object o) {
        if (o instanceof JdbcReadOptions) {
            ...
            return Objects.equals(query, options.query) && Objects.equals(partitionColumnName,
                    options.partitionColumnName
            ) && Objects.equals(partitionLowerBound, options.partitionLowerBound) && Objects.equals(partitionUpperBound,
                    options.partitionUpperBound
            ) && Objects.equals(numPartitions, options.numPartitions) && Objects.equals(fetchSize, options.fetchSize)
    ...
    public static class Builder {
        ...
        public JdbcReadOptions build() {
            return new JdbcReadOptions(query,
                    partitionColumnName,
                    partitionLowerBound,
                    partitionUpperBound,
                    numPartitions,
