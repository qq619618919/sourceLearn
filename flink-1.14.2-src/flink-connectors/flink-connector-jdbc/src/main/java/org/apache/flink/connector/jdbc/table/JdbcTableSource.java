...
public class JdbcTableSource implements StreamTableSource<Row>, ProjectableTableSource<Row>, LookupableTableSource<Row> {
    ...
    private JdbcTableSource(JdbcConnectorOptions options,
    ...
    public DataStream<Row> getDataStream(StreamExecutionEnvironment execEnv) {
        return execEnv
                .createInput(getInputFormat(), (RowTypeInfo) fromDataTypeToLegacyInfo(producedDataType))
                .name(explainSource());
    }
    ...
    private JdbcInputFormat getInputFormat() {
         ...
         *  注释：
         */
        JdbcInputFormat.JdbcInputFormatBuilder builder = JdbcInputFormat
        ...
        if (readOptions.getPartitionColumnName().isPresent()) {
            ...
            builder.setParametersProvider(new JdbcNumericBetweenParametersProvider(lowerBound, upperBound).ofBatchNum(
                    numPartitions));
    ...
    private String getBaseQueryStatement(RowTypeInfo rowTypeInfo) {
        return readOptions
                .getQuery()
                .orElseGet(() -> FieldNamedPreparedStatementImpl.parseNamedStatement(options
                                .getDialect()
                                .getSelectFromStatement(options.getTableName(), rowTypeInfo.getFieldNames(), new String[0]),
                        new HashMap<>()
                ));
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof JdbcTableSource) {
            ...
            return Objects.equals(options, source.options) && Objects.equals(readOptions, source.readOptions)
                    && Objects.equals(lookupOptions, source.lookupOptions) && Objects.equals(schema, source.schema)
