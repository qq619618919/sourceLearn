...
public class CliFrontendParser {
    ...
    static final Option HELP_OPTION = new Option("h",
            "help",
            false,
    ...
    static final Option CLASS_OPTION = new Option("c",
            "class",
            true,
    ...
    static final Option CLASSPATH_OPTION = new Option("C",
            "classpath",
            true,
    ...
    public static final Option SHUTDOWN_IF_ATTACHED_OPTION = new Option("sae",
    ...
    public static final Option ARGS_OPTION = new Option("a",
            "arguments",
            true,
            "Program arguments. Arguments can also be added without -a, simply as trailing parameters."
    );

    public static final Option ADDRESS_OPTION = new Option("m",
            "jobmanager",
            true,
    ...
    public static final Option SAVEPOINT_ALLOW_NON_RESTORED_OPTION = new Option("n",
    ...
    static final Option RUNNING_OPTION = new Option("r",
            "running",
            false,
            "Show only running programs and their JobIDs"
    );

    static final Option SCHEDULED_OPTION = new Option("s",
            "scheduled",
            false,
    ...
    static final Option CANCEL_WITH_SAVEPOINT_OPTION = new Option("s",
            "withSavepoint",
            true,
            "**DEPRECATION WARNING**: "
                    ...
                    + "specified, the configured default directory (" + CheckpointingOptions.SAVEPOINT_DIRECTORY.key()
                    + ") is used."
    );

    public static final Option STOP_WITH_SAVEPOINT_PATH = new Option("p",
            "savepointPath",
            true,
    ...
    public static final Option STOP_AND_DRAIN = new Option("d",
            "drain",
            false,
            "Send MAX_WATERMARK before taking the savepoint and stopping the pipelne."
    );

    public static final Option PY_OPTION = new Option("py",
            "python",
            true,
    ...
    public static final Option PYCLIENTEXEC_OPTION = new Option("pyclientexec",
            "pyClientExecutable",
            true,
     ...
     *         options
     */
    private static void printCustomCliOptions(Collection<CustomCommandLine> customCommandLines,
