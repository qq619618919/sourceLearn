...
public class StreamContextEnvironment extends StreamExecutionEnvironment {
    ...
    public StreamContextEnvironment(final PipelineExecutorServiceLoader executorServiceLoader,
    ...
    public JobExecutionResult execute(StreamGraph streamGraph) throws Exception {
        ...
        try {
            ...
            jobListeners.forEach(jobListener -> jobListener.onJobExecuted(null,
    ...
    private JobExecutionResult getJobExecutionResult(final JobClient jobClient) throws Exception {
        ...
        if (configuration.getBoolean(DeploymentOptions.ATTACHED)) {
            ...
            if (configuration.getBoolean(DeploymentOptions.SHUTDOWN_IF_ATTACHED)) {
                ...
                jobExecutionResultFuture.whenComplete((ignored, throwable) -> ShutdownHookUtil.removeShutdownHook(
                        shutdownHook,
    ...
    public static void setAsContext(final PipelineExecutorServiceLoader executorServiceLoader,
        ...
        StreamExecutionEnvironmentFactory factory = conf -> {
             ...
             *  注释：
             */
            return new StreamContextEnvironment(executorServiceLoader,
                    mergedConfiguration,
                    userCodeClassLoader,
