...
public final class FlinkPipelineTranslationUtil {
     ...
     */
    public static JobGraph getJobGraphUnderUserClassLoader(final ClassLoader userClassloader,
    ...
    private static FlinkPipelineTranslator getPipelineTranslator(Pipeline pipeline) {
        ...
        throw new RuntimeException(
                "Translator " + streamGraphTranslator + " cannot translate " + "the given pipeline " + pipeline + ".");
    }
}
