...
public class StateBackendOptions {
    ...
    public static final ConfigOption<Boolean> LATENCY_TRACK_ENABLED = ConfigOptions
            ...
            .booleanType()
            .defaultValue(false)
            .withDescription("Whether to track latency of keyed state operations, e.g value state put/get/clear.");
    ...
    @Documentation.Section(Documentation.Sections.STATE_BACKEND_LATENCY_TRACKING)
    public static final ConfigOption<Integer> LATENCY_TRACK_HISTORY_SIZE = ConfigOptions
            .key("state.backend.latency-track.history-size")
            .intType()
            .defaultValue(128)
            .withDescription("Defines the number of measured latencies to maintain at each state access operation.");
}
