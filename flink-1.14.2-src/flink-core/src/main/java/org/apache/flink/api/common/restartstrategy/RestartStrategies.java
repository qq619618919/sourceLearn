...
public class RestartStrategies {
     ...
     */
    public static RestartStrategyConfiguration fixedDelayRestart(int restartAttempts,
     ...
     */
    public static FailureRateRestartStrategyConfiguration failureRateRestart(int failureRate,
     ...
     */
    public static ExponentialDelayRestartStrategyConfiguration exponentialDelayRestart(Time initialBackoff,
                                                                                       Time maxBackoff,
                                                                                       double backoffMultiplier,
                                                                                       Time resetBackoffThreshold,
                                                                                       double jitterFactor) {
        return new ExponentialDelayRestartStrategyConfiguration(initialBackoff,
                maxBackoff,
                backoffMultiplier,
    ...
    public static final class FixedDelayRestartStrategyConfiguration extends RestartStrategyConfiguration {
        ...
        @Override
        public String getDescription() {
            return String.format("Restart with fixed delay (%s). #%d restart attempts.",
    ...
    public static final class ExponentialDelayRestartStrategyConfiguration extends RestartStrategyConfiguration {
        ...
        public ExponentialDelayRestartStrategyConfiguration(Time initialBackoff,
                                                            Time maxBackoff,
                                                            double backoffMultiplier,
                                                            Time resetBackoffThreshold,
                                                            double jitterFactor) {
        ...
        @Override
        public String getDescription() {
            return String.format("Restart with exponential delay: starting at %s, increasing by %f, with maximum %s. "
        ...
        public boolean equals(Object o) {
            ...
            return Double.compare(that.backoffMultiplier, backoffMultiplier) == 0
                    && Double.compare(that.jitterFactor, jitterFactor) == 0 && Objects.equals(initialBackoff,
                    that.initialBackoff
            ) && Objects.equals(maxBackoff, that.maxBackoff) && Objects.equals(resetBackoffThreshold,
    ...
    public static final class FailureRateRestartStrategyConfiguration extends RestartStrategyConfiguration {
        ...
        public FailureRateRestartStrategyConfiguration(int maxFailureRate,
                                                       Time failureInterval,
                                                       Time delayBetweenAttemptsInterval) {
        ...
        public boolean equals(Object o) {
            ...
            return maxFailureRate == that.maxFailureRate && Objects.equals(failureInterval, that.failureInterval)
     ...
     *  注释：
     */
    private static RestartStrategyConfiguration parseConfiguration(String restartstrategyKind,
        ...
        switch (restartstrategyKind.toLowerCase()) {
            ...
            case "exponential-delay":
                Duration initialBackoff = configuration.get(
                ...
                double backoffMultiplier = configuration.get(
                        RestartStrategyOptions.RESTART_STRATEGY_EXPONENTIAL_DELAY_BACKOFF_MULTIPLIER);
                Duration resetBackoffThreshold = configuration.get(
                ...
                return exponentialDelayRestart(Time.milliseconds(initialBackoff.toMillis()),
            ...
            case "failure-rate":
                ...
                Duration failureRateInterval = configuration.get(
                ...
                return failureRateRestart(maxFailures,
