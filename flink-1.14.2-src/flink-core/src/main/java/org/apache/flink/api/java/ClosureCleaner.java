    ...
    private static void clean(Object func,
        ...
        for (Field f : cls.getDeclaredFields()) {
            if (f.getName().startsWith("this$")) {
                ...
                try {
                    ...
                    throw new RuntimeException(String.format("Can not access to the %s field in Class %s",
                            f.getName(),
                            func.getClass()
                    ));
                }
        ...
        if (checkSerializable) {
            try {
                ...
                String msg = functionType == null ? (func + " is not serializable.") : ("The implementation of the "
