...
public class TaskManagerOptions {
     ...
     */
    @Deprecated
    public static final ConfigOption<MemorySize> TASK_MANAGER_HEAP_MEMORY = key("taskmanager.heap.size")
            .memoryType()
            .noDefaultValue()
     ...
     */
    @Deprecated
    public static final ConfigOption<Integer> TASK_MANAGER_HEAP_MEMORY_MB = key("taskmanager.heap.mb")
            .intType()
            .noDefaultValue()
    ...
    public static final ConfigOption<Boolean> KILL_ON_OUT_OF_MEMORY = key("taskmanager.jvm-exit-on-oom")
            .booleanType()
            .defaultValue(false)
     ...
     */
    @Deprecated
    public static final ConfigOption<Boolean> EXIT_ON_FATAL_AKKA_ERROR = key("taskmanager.exit-on-fatal-akka-error")
            .booleanType()
            .defaultValue(false)
    ...
    public static final ConfigOption<String> HOST = key("taskmanager.host")
            .stringType()
            .noDefaultValue()
    ...
    public static final ConfigOption<String> BIND_HOST = key("taskmanager.bind-host")
            .stringType()
            .noDefaultValue()
     ...
     */
    @Documentation.Section({Documentation.Sections.COMMON_HOST_PORT, Documentation.Sections.ALL_TASK_MANAGER})
    public static final ConfigOption<String> RPC_PORT = key("taskmanager.rpc.port")
            .stringType()
            .defaultValue("0")
    ...
    public static final ConfigOption<Integer> RPC_BIND_PORT = key("taskmanager.rpc.bind-port")
            .intType()
            .noDefaultValue()
     ...
     */
    @Deprecated
    public static final ConfigOption<Duration> REGISTRATION_MAX_BACKOFF = key("taskmanager.registration.max-backoff")
            .durationType()
     ...
     */
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<Duration> REGISTRATION_TIMEOUT = key("taskmanager.registration.timeout")
            .durationType()
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<Integer> NUM_TASK_SLOTS = key("taskmanager.numberOfTaskSlots")
            .intType()
            .defaultValue(1)
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<Duration> SLOT_TIMEOUT = key("taskmanager.slot.timeout")
            .durationType()
            .defaultValue(AkkaOptions.ASK_TIMEOUT_DURATION.defaultValue())
            .withFallbackKeys(AkkaOptions.ASK_TIMEOUT_DURATION.key())
            .withDescription(Description
                    .builder()
                    .text("Timeout used for identifying inactive slots. The TaskManager will free the slot if it does not become active "
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<Boolean> DEBUG_MEMORY_LOG = key("taskmanager.debug.memory.log")
            .booleanType()
            .defaultValue(false)
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<MemorySize> MEMORY_SEGMENT_SIZE = key("taskmanager.memory.segment-size")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<MemorySize> MIN_MEMORY_SEGMENT_SIZE = key("taskmanager.memory.min-segment-size")
            .memoryType()
     ...
     */
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<String> HOST_BIND_POLICY = key("taskmanager.network.bind-policy")
            .stringType()
            .defaultValue("ip")
            .withDescription(Description
                    .builder()
                    .text("The automatic address binding policy used by the TaskManager if \"" + HOST.key()
                            + "\" is not set." + " The value should be one of the following:\n")
     ...
     */
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<String> TASK_MANAGER_RESOURCE_ID = key("taskmanager.resource-id")
            .stringType()
            .noDefaultValue()
            .withDescription(
                    "The TaskManager's ResourceID. If not configured, the ResourceID will be generated with the "
    ...
    public static final ConfigOption<Double> CPU_CORES = key("taskmanager.cpu.cores")
            .doubleType()
            .noDefaultValue()
            .withDescription("CPU cores for the TaskExecutors. In case of Yarn setups, this value will be rounded to "
                    ...
                    + "used for Yarn / Kubernetes setups, and '" + NUM_TASK_SLOTS.key() + "' will be used for "
                    + "standalone setups (approximate number of slots).");

    /** Total Process Memory size for the TaskExecutors. */
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> TOTAL_PROCESS_MEMORY = key("taskmanager.memory.process.size")
            .memoryType()
            .noDefaultValue()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> TOTAL_FLINK_MEMORY = key("taskmanager.memory.flink.size")
            .memoryType()
            .noDefaultValue()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> FRAMEWORK_HEAP_MEMORY = key("taskmanager.memory.framework.heap.size")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> TASK_HEAP_MEMORY = key("taskmanager.memory.task.heap.size")
            .memoryType()
            .noDefaultValue()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> TASK_OFF_HEAP_MEMORY = key("taskmanager.memory.task.off-heap.size")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> MANAGED_MEMORY_SIZE = key("taskmanager.memory.managed.size")
            .memoryType()
            .noDefaultValue()
     ...
     */
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<Float> MANAGED_MEMORY_FRACTION = key("taskmanager.memory.managed.fraction")
            .floatType()
            .defaultValue(0.4f)
            .withDescription(
    ...
    public static final ConfigOption<Map<String, String>> MANAGED_MEMORY_CONSUMER_WEIGHTS = key(
            ...
            .withDescription("Managed memory weights for different kinds of consumers. A slot’s"
                    ...
                    + " Currently supported kinds of consumers are " + MANAGED_MEMORY_CONSUMER_NAME_OPERATOR
                    + " (for built-in algorithms), " + MANAGED_MEMORY_CONSUMER_NAME_STATE_BACKEND
                    + " (for RocksDB state backend) and " + MANAGED_MEMORY_CONSUMER_NAME_PYTHON
                    + " (for Python processes).");

    /** Min Network Memory size for TaskExecutors. */
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> NETWORK_MEMORY_MIN = key("taskmanager.memory.network.min")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> NETWORK_MEMORY_MAX = key("taskmanager.memory.network.max")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<Float> NETWORK_MEMORY_FRACTION = key("taskmanager.memory.network.fraction")
            .floatType()
            .defaultValue(0.1f)
    ...
    public static final ConfigOption<Duration> BUFFER_DEBLOAT_PERIOD = ConfigOptions
            .key("taskmanager.network.memory.buffer-debloat.period")
            .durationType()
            .defaultValue(Duration.ofMillis(500))
            .withDescription("The minimum period of time after which the buffer size will be debloated if required. "
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER_NETWORK)
    public static final ConfigOption<Integer> BUFFER_DEBLOAT_SAMPLES = ConfigOptions
            .key("taskmanager.network.memory.buffer-debloat.samples")
            .intType()
            .defaultValue(20)
            .withDescription(
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER_NETWORK)
    public static final ConfigOption<Duration> BUFFER_DEBLOAT_TARGET = ConfigOptions
            .key("taskmanager.network.memory.buffer-debloat.target")
            .durationType()
            .defaultValue(Duration.ofSeconds(1))
            .withDescription("The target total time after which buffered in-flight data should be fully consumed. "
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER_NETWORK)
    public static final ConfigOption<Boolean> BUFFER_DEBLOAT_ENABLED = ConfigOptions
            .key("taskmanager.network.memory.buffer-debloat.enabled")
            .booleanType()
            .defaultValue(false)
            .withDescription("The switch of the automatic buffered debloating feature. "
     ...
     */
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER_NETWORK)
    public static final ConfigOption<Integer> BUFFER_DEBLOAT_THRESHOLD_PERCENTAGES = ConfigOptions
            .key("taskmanager.network.memory.buffer-debloat.threshold-percentages")
            .intType()
            .defaultValue(50)
            .withDescription(
    ...
    public static final ConfigOption<MemorySize> NETWORK_BATCH_SHUFFLE_READ_MEMORY = key(
            ...
            .withDescription(String.format("Size of memory used by blocking shuffle for shuffle data read "
                            ...
                            + "can increase this config value for large-scale batch" + " jobs (for example, to 128M or 256M).",
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> JVM_METASPACE = key("taskmanager.memory.jvm-metaspace.size")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> JVM_OVERHEAD_MIN = key("taskmanager.memory.jvm-overhead.min")
            .memoryType()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<MemorySize> JVM_OVERHEAD_MAX = key("taskmanager.memory.jvm-overhead.max")
            .memoryType()
            .defaultValue(MemorySize.parse("1g"))
    ...
    @Documentation.Section(Documentation.Sections.COMMON_MEMORY)
    public static final ConfigOption<Float> JVM_OVERHEAD_FRACTION = key("taskmanager.memory.jvm-overhead.fraction")
            .floatType()
            .defaultValue(0.1f)
    ...
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<Long> TASK_CANCELLATION_INTERVAL = key("task.cancellation.interval")
            .longType()
            .defaultValue(30000L)
     ...
     */
    @Documentation.Section(Documentation.Sections.ALL_TASK_MANAGER)
    public static final ConfigOption<Long> TASK_CANCELLATION_TIMEOUT = key("task.cancellation.timeout")
            .longType()
