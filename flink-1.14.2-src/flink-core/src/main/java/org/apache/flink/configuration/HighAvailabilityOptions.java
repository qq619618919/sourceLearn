...
public class HighAvailabilityOptions {
    ...
    public static final ConfigOption<String> HA_MODE = key("high-availability")
            .defaultValue("NONE")
     ...
     */
    @Documentation.Section(Documentation.Sections.COMMON_HIGH_AVAILABILITY)
    public static final ConfigOption<String> HA_CLUSTER_ID = key("high-availability.cluster-id")
    ...
    @Documentation.Section(Documentation.Sections.COMMON_HIGH_AVAILABILITY)
    public static final ConfigOption<String> HA_STORAGE_PATH = key("high-availability.storageDir")
            .noDefaultValue()
    ...
    public static final ConfigOption<String> HA_JOB_MANAGER_PORT_RANGE = key("high-availability.jobmanager.port")
            .stringType()
            .defaultValue("0")
    ...
    public static final ConfigOption<String> HA_ZOOKEEPER_QUORUM = key("high-availability.zookeeper.quorum")
            .noDefaultValue()
    ...
    @Documentation.Section(Documentation.Sections.COMMON_HIGH_AVAILABILITY_ZOOKEEPER)
    public static final ConfigOption<String> HA_ZOOKEEPER_ROOT = key("high-availability.zookeeper.path.root")
            .defaultValue("/flink")
    ...
    public static final ConfigOption<String> HA_ZOOKEEPER_JOBGRAPHS_PATH = key(
    ...
    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<Integer> ZOOKEEPER_SESSION_TIMEOUT = key(
    ...
    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<Integer> ZOOKEEPER_CONNECTION_TIMEOUT = key(
    ...
    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<Integer> ZOOKEEPER_RETRY_WAIT = key("high-availability.zookeeper.client.retry-wait")
            .defaultValue(5000)
    ...
    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<Integer> ZOOKEEPER_MAX_RETRY_ATTEMPTS = key(
    ...
    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<String> ZOOKEEPER_RUNNING_JOB_REGISTRY_PATH = key(
            "high-availability.zookeeper.path.running-registry").defaultValue("/running_job_registry/");

    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<String> ZOOKEEPER_CLIENT_ACL = key("high-availability.zookeeper.client.acl")
            .defaultValue("open")
            .withDescription(
    ...
    @Documentation.Section(Documentation.Sections.EXPERT_ZOOKEEPER_HIGH_AVAILABILITY)
    public static final ConfigOption<Boolean> ZOOKEEPER_TOLERATE_SUSPENDED_CONNECTIONS = key(
            "high-availability.zookeeper.client.tolerate-suspended-connections")
            .booleanType()
            .defaultValue(false)
            .withDescription(Description
                    .builder()
                    .text("Defines whether a suspended ZooKeeper connection will be treated as an error that causes the leader "
                            ...
                            + "more likely into timing issues with ZooKeeper.", TextElement.code("true"))
                    .build());
     ...
     */
    @Deprecated
    public static final ConfigOption<String> HA_JOB_DELAY = key("high-availability.job.delay")
            .noDefaultValue()
