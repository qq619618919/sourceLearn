...
public class BlobServerOptions {
    ...
    public static final ConfigOption<Integer> FETCH_RETRIES = key("blob.fetch.retries")
            .defaultValue(5)
     ...
     * JobManager serves.
     */
    public static final ConfigOption<Integer> FETCH_CONCURRENT = key("blob.fetch.num-concurrent")
            .defaultValue(50)
            .withDescription(
    ...
    public static final ConfigOption<Integer> FETCH_BACKLOG = key("blob.fetch.backlog")
            .defaultValue(1000)
     ...
     */
    public static final ConfigOption<String> PORT = key("blob.server.port")
            .defaultValue("0")
    ...
    public static final ConfigOption<Boolean> SSL_ENABLED = key("blob.service.ssl.enabled")
            .defaultValue(true)
     ...
     */
    public static final ConfigOption<Long> CLEANUP_INTERVAL = key("blob.service.cleanup.interval").defaultValue(3_600L) // once per hour
    ...
    public static final ConfigOption<Integer> OFFLOAD_MINSIZE = key("blob.offload.minsize").defaultValue(
                    1_024 * 1_024) // 1MiB by default
    ...
    public static final ConfigOption<Integer> SO_TIMEOUT = key("blob.client.socket.timeout")
    ...
    public static final ConfigOption<Integer> CONNECT_TIMEOUT = key("blob.client.connect.timeout")
            .defaultValue(0)
