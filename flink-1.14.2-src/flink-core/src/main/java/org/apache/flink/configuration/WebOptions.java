...
public class WebOptions {
    ...
    @Deprecated
    public static final ConfigOption<String> ADDRESS = key("web.address")
            .noDefaultValue()
     ...
     */
    @Deprecated
    public static final ConfigOption<Integer> PORT = key("web.port")
            .defaultValue(8081)
     ...
     * the web-frontend.
     */
    public static final ConfigOption<String> ACCESS_CONTROL_ALLOW_ORIGIN = key("web.access-control-allow-origin")
            .defaultValue("*")
    ...
    public static final ConfigOption<Long> REFRESH_INTERVAL = key("web.refresh-interval")
            .defaultValue(3000L)
    ...
    @Deprecated
    public static final ConfigOption<Boolean> SSL_ENABLED = key("web.ssl.enabled")
            .defaultValue(true)
    ...
    public static final ConfigOption<String> TMP_DIR = key("web.tmpdir")
     ...
     */
    public static final ConfigOption<String> UPLOAD_DIR = key("web.upload.dir")
            .noDefaultValue()
    ...
    public static final ConfigOption<Integer> ARCHIVE_COUNT = key("web.history")
            .defaultValue(5)
     ...
     * YARN).
     */
    public static final ConfigOption<String> LOG_PATH = key("web.log.path")
            .noDefaultValue()
    ...
    public static final ConfigOption<Boolean> SUBMIT_ENABLE = key("web.submit.enable")
            .defaultValue(true)
    ...
    public static final ConfigOption<Boolean> CANCEL_ENABLE = key("web.cancel.enable")
            .booleanType()
            .defaultValue(true)
            .withDescription("Flag indicating whether jobs can be canceled from the web-frontend.");

    /** Config parameter defining the number of checkpoints to remember for recent history. */
    public static final ConfigOption<Integer> CHECKPOINTS_HISTORY_SIZE = key("web.checkpoints.history")
            .defaultValue(10)
    ...
    public static final ConfigOption<Integer> MAX_EXCEPTION_HISTORY_SIZE = key("web.exception-history-size")
            .intType()
            .defaultValue(16)
            .withDescription("The maximum number of failures collected by the exception history per job.");

    /** @deprecated - no longer used. */
    @Deprecated
    public static final ConfigOption<Integer> BACKPRESSURE_CLEANUP_INTERVAL = key("web.backpressure.cleanup-interval")
    ...
    /** @deprecated - no longer used. */
    @Deprecated
    public static final ConfigOption<Integer> BACKPRESSURE_REFRESH_INTERVAL = key("web.backpressure.refresh-interval")
    ...
    /** @deprecated - no longer used. */
    @Deprecated
    public static final ConfigOption<Integer> BACKPRESSURE_NUM_SAMPLES = key("web.backpressure.num-samples")
            .defaultValue(100)
    ...
    /** @deprecated - no longer used. */
    @Deprecated
    public static final ConfigOption<Integer> BACKPRESSURE_DELAY = key("web.backpressure.delay-between-samples")
            .defaultValue(50)
    ...
    public static final ConfigOption<Long> TIMEOUT = key("web.timeout")
