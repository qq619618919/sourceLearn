...
public class TypeExtractor {
    ...
    @PublicEvolving
    public static <IN, OUT> TypeInformation<OUT> getMapReturnTypes(MapFunction<IN, OUT> mapInterface,
    ...
    public static <IN, OUT> TypeInformation<OUT> getMapReturnTypes(MapFunction<IN, OUT> mapInterface,
        ...
        return getUnaryOperatorReturnType(mapInterface,
                MapFunction.class,
                0,
                1,
                NO_INDEX,
    ...
    @PublicEvolving
    public static <IN, OUT> TypeInformation<OUT> getFlatMapReturnTypes(FlatMapFunction<IN, OUT> flatMapInterface,
                                                                       TypeInformation<IN> inType) {
    ...
    public static <IN, OUT> TypeInformation<OUT> getFlatMapReturnTypes(FlatMapFunction<IN, OUT> flatMapInterface,
                                                                       ...
                                                                       String functionName,
                                                                       boolean allowMissing) {
        return getUnaryOperatorReturnType(flatMapInterface,
    ...
    @PublicEvolving
    public static <IN, ACC> TypeInformation<ACC> getAggregateFunctionAccumulatorType(AggregateFunction<IN, ACC, ?> function,
                                                                                     TypeInformation<IN> inType,
                                                                                     String functionName,
                                                                                     boolean allowMissing) {
    ...
    @PublicEvolving
    public static <IN, OUT> TypeInformation<OUT> getAggregateFunctionReturnType(AggregateFunction<IN, ?, OUT> function,
                                                                                TypeInformation<IN> inType,
                                                                                String functionName,
                                                                                boolean allowMissing) {
        return getUnaryOperatorReturnType(function,
    ...
    @PublicEvolving
    public static <IN, OUT> TypeInformation<OUT> getMapPartitionReturnTypes(MapPartitionFunction<IN, OUT> mapPartitionInterface,
                                                                            TypeInformation<IN> inType) {
    ...
    public static <IN, OUT> TypeInformation<OUT> getMapPartitionReturnTypes(MapPartitionFunction<IN, OUT> mapPartitionInterface,
                                                                            ...
                                                                            String functionName,
                                                                            boolean allowMissing) {
        return getUnaryOperatorReturnType(mapPartitionInterface,
    ...
    public static <IN, OUT> TypeInformation<OUT> getGroupReduceReturnTypes(GroupReduceFunction<IN, OUT> groupReduceInterface,
                                                                           ...
                                                                           String functionName,
                                                                           boolean allowMissing) {
        return getUnaryOperatorReturnType(groupReduceInterface,
    ...
    @PublicEvolving
    public static <IN, OUT> TypeInformation<OUT> getGroupCombineReturnTypes(GroupCombineFunction<IN, OUT> combineInterface,
                                                                            TypeInformation<IN> inType) {
    ...
    public static <IN, OUT> TypeInformation<OUT> getGroupCombineReturnTypes(GroupCombineFunction<IN, OUT> combineInterface,
                                                                            ...
                                                                            String functionName,
                                                                            boolean allowMissing) {
        return getUnaryOperatorReturnType(combineInterface,
    ...
    public static <IN1, IN2, OUT> TypeInformation<OUT> getFlatJoinReturnTypes(FlatJoinFunction<IN1, IN2, OUT> joinInterface,
                                                                              ...
                                                                              String functionName,
                                                                              boolean allowMissing) {
        return getBinaryOperatorReturnType(joinInterface,
    ...
    public static <IN1, IN2, OUT> TypeInformation<OUT> getCoGroupReturnTypes(CoGroupFunction<IN1, IN2, OUT> coGroupInterface,
                                                                             ...
                                                                             String functionName,
                                                                             boolean allowMissing) {
        return getBinaryOperatorReturnType(coGroupInterface,
    ...
    public static <IN1, IN2, OUT> TypeInformation<OUT> getCrossReturnTypes(CrossFunction<IN1, IN2, OUT> crossInterface,
                                                                           ...
                                                                           String functionName,
                                                                           boolean allowMissing) {
        return getBinaryOperatorReturnType(crossInterface,
                CrossFunction.class,
                0,
                1,
                2,
    ...
    public static <IN, OUT> TypeInformation<OUT> getKeySelectorTypes(KeySelector<IN, OUT> selectorInterface,
                                                                     ...
                                                                     String functionName,
                                                                     boolean allowMissing) {
        return getUnaryOperatorReturnType(selectorInterface,
                KeySelector.class,
                0,
                1,
                NO_INDEX,
    ...
    public static <T> TypeInformation<T> getPartitionerTypes(Partitioner<T> partitioner,
        ...
        return getUnaryOperatorReturnType(partitioner,
                Partitioner.class,
                -1,
                0,
                new int[]{0},
    ...
    public static <IN> TypeInformation<IN> getInputFormatTypes(InputFormat<IN, ?> inputFormatInterface) {
        ...
        return new TypeExtractor().privateCreateTypeInfo(InputFormat.class,
    ...
    public static <IN, OUT> TypeInformation<OUT> getUnaryOperatorReturnType(Function function,
        ...
        Preconditions.checkArgument(inType == null || inputTypeArgumentIndex >= 0,
        ...
        Preconditions.checkArgument(lambdaOutputTypeArgumentIndices != null,
        ...
        try {
            ...
            if (exec != null) {
                ...
                if (lambdaOutputTypeArgumentIndices.length > 0) {
                    output = TypeExtractionUtils.extractTypeFromLambda(baseClass,
                            exec,
            ...
            if (allowMissing) {
                return (TypeInformation<OUT>) new MissingTypeInfo(
    ...
    public static <IN1, IN2, OUT> TypeInformation<OUT> getBinaryOperatorReturnType(Function function,
        ...
        Preconditions.checkArgument(in1Type == null || input1TypeArgumentIndex >= 0,
                "Input 1 type argument index was not provided"
        );
        Preconditions.checkArgument(in2Type == null || input2TypeArgumentIndex >= 0,
    ...
    @PublicEvolving
    public static <IN1, IN2, OUT> TypeInformation<OUT> createTypeInfo(Class<?> baseClass,
                                                                      Class<?> clazz,
                                                                      int returnParamPos,
                                                                      TypeInformation<IN1> in1Type,
                                                                      TypeInformation<IN2> in2Type) {
        TypeInformation<OUT> ti = new TypeExtractor().privateCreateTypeInfo(baseClass,
                clazz,
                returnParamPos,
                in1Type,
                in2Type
    ...
    // for (Rich)Functions
    @SuppressWarnings("unchecked")
    private <IN1, IN2, OUT> TypeInformation<OUT> privateCreateTypeInfo(Class<?> baseClass,
                                                                       Class<?> clazz,
                                                                       int returnParamPos,
                                                                       TypeInformation<IN1> in1Type,
                                                                       TypeInformation<IN2> in2Type) {
        ...
        if (returnType instanceof TypeVariable<?>) {
            typeInfo = (TypeInformation<OUT>) createTypeInfoFromInputs((TypeVariable<?>) returnType,
                    typeHierarchy,
                    in1Type,
                    in2Type
            );
    ...
    private <IN1, IN2, OUT> TypeInformation<OUT> createTypeInfoWithTypeHierarchy(List<Type> typeHierarchy,
                                                                                 Type t,
                                                                                 TypeInformation<IN1> in1Type,
                                                                                 TypeInformation<IN2> in2Type) {
        ...
        // check if type is a subclass of tuple
            ...
            final TypeInformation<?>[] subTypesInfo = createSubTypesInfo(t,
        ...
        // e.g. class MyMapper<E> extends MapFunction<String, E>
            ...
            // as a last attempt
                ...
                TypeInformation<OUT> typeInfo = (TypeInformation<OUT>) createTypeInfoFromInputs((TypeVariable<?>) t,
                        typeHierarchy,
                        in1Type,
                        in2Type
                );
                if (typeInfo != null) {
                    ...
                    throw new InvalidTypesException(
                            "Type of TypeVariable '" + ((TypeVariable<?>) t).getName() + "' in '"
        ...
        // arrays with generics
            ...
            if (componentType instanceof Class) {
                ...
                TypeInformation<?> componentInfo = createTypeInfoWithTypeHierarchy(typeHierarchy,
    ...
    private <IN1, IN2> TypeInformation<?> createTypeInfoFromInputs(TypeVariable<?> returnTypeVar,
    ...
    private <IN1> TypeInformation<?> createTypeInfoFromInput(TypeVariable<?> returnTypeVar,
        ...
        else if (inTypeInfo instanceof TupleTypeInfo && isClassType(inType) && Tuple.class.isAssignableFrom(typeToClass(
                inType))) {
     ...
     */
    private <IN1, IN2> TypeInformation<?>[] createSubTypesInfo(Type originalType,
        ...
        for (int i = 0; i < subtypes.length; i++) {
            ...
            if (subtypes[i] instanceof TypeVariable<?>) {
                subTypesInfo[i] = createTypeInfoFromInputs((TypeVariable<?>) subtypes[i],
                        subTypeHierarchy,
                        in1Type,
                        in2Type
                );
                ...
                if (subTypesInfo[i] == null && !lenient) {
                    throw new InvalidTypesException(
                            "Type of TypeVariable '" + ((TypeVariable<?>) subtypes[i]).getName() + "' in '"
     ...
     */
    @SuppressWarnings("unchecked")
    private <IN1, IN2, OUT> TypeInformation<OUT> createTypeInfoFromFactory(Type t,
                                                                           List<Type> typeHierarchy,
                                                                           TypeInformation<IN1> in1Type,
                                                                           TypeInformation<IN2> in2Type) {
        ...
        return createTypeInfoFromFactory(t, in1Type, in2Type, factoryHierarchy, factory, factoryDefiningType);
    }
    ...
    private <IN1, IN2, OUT> TypeInformation<OUT> createTypeInfoFromFactory(Type t,
        ...
        if (factoryDefiningType instanceof ParameterizedType) {
            ...
            final TypeInformation<?>[] subtypeInfo = createSubTypesInfo(t,
                    paramDefiningType,
                    factoryHierarchy,
                    in1Type,
                    in2Type,
    ...
    private static void validateInputType(Class<?> baseClass,
                                          Class<?> clazz,
                                          int inputParamPos,
        ...
        if (!(type instanceof TypeVariable<?>)) {
            ...
            // check for POJO
                ...
                if (!(isClassType(type) && ((PojoTypeInfo<?>) typeInfo).getTypeClass() == (clazz = typeToClass(type))
                    ...
                    throw new InvalidTypesException(
                            "POJO type '" + ((PojoTypeInfo<?>) typeInfo).getTypeClass().getCanonicalName()
            ...
            // check for Enum
                ...
                if (!(typeInfo.getTypeClass() == type)) {
                    throw new InvalidTypesException(
                            "Enum type '" + typeInfo.getTypeClass().getCanonicalName() + "' expected but was '"
            ...
            // check for generic object
                ...
                Class<?> clazz = null;
                if (!(isClassType(type)
                        && (clazz = typeToClass(type)).isAssignableFrom(((GenericTypeInfo<?>) typeInfo).getTypeClass())
                )) {
                    throw new InvalidTypesException(
                            "Generic type '" + ((GenericTypeInfo<?>) typeInfo).getTypeClass().getCanonicalName()
                                    + "' or a subclass of it expected but was '" + clazz.getCanonicalName() + "'.");
                }
            }
            // check for Writable
            else {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    private <OUT, IN1, IN2> TypeInformation<OUT> privateGetForClass(Class<OUT> clazz,
                                                                    List<Type> typeHierarchy,
    ...
    private boolean isValidPojoField(Field f, Class<?> clazz, List<Type> typeHierarchy) {
        if (Modifier.isPublic(f.getModifiers())) {
            ...
            for (Method m : clazz.getMethods()) {
                final String methodNameLow = m.getName().endsWith("_$eq") ? m
                        .getName()
                        .toLowerCase()
                        .replaceAll("_", "")
                        .replaceFirst("\\$eq$", "_\\$eq") : m.getName().toLowerCase().replaceAll("_", "");
                ...
                if ( // The name should be "get<FieldName>" or "<fieldName>" (for scala) or
                    // "is<fieldName>" for boolean fields.
                        (methodNameLow.equals("get" + fieldNameLow) || methodNameLow.equals("is" + fieldNameLow)
                                ...
                                (m.getGenericReturnType().equals(fieldType) || (m
                                        .getReturnType()
                                        .equals(fieldTypeWrapper)
                ...
                if ((methodNameLow.equals("set" + fieldNameLow) || methodNameLow.equals(fieldNameLow + "_$eq"))
                        ...
                        (m.getGenericParameterTypes()[0].equals(fieldType) || (m.getParameterTypes()[0].equals(
                                fieldTypeWrapper)
    ...
    @SuppressWarnings("unchecked")
    protected <OUT, IN1, IN2> TypeInformation<OUT> analyzePojo(Type type,
                                                               List<Type> typeHierarchy,
                                                               TypeInformation<IN1> in1Type,
                                                               TypeInformation<IN2> in2Type) {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                if (factory != null) {
                    typeInfo = createTypeInfoFromFactory(fieldType,
                            in1Type,
                            in2Type,
                            fieldTypeHierarchy,
                            factory,
            ...
            for (Field field : fields) {
                ...
                if (hasFieldWithSameName(field.getName(), result)) {
                    if (ignoreDuplicates) {
                        ...
                        throw new InvalidTypesException(
                                "The field " + field + " is already contained in the hierarchy of the " + clazz + "."
    ...
    private <X> TypeInformation<X> privateGetForObject(X value) {
        ...
        final TypeInformation<X> typeFromFactory = createTypeInfoFromFactory(value.getClass(),
                typeHierarchy,
                null,
                null
        );
        ...
        if (value instanceof Tuple) {
            ...
            if (numFields != countFieldsInClass(value.getClass())) {
                ...
                return analyzePojo(value.getClass(),
                        new ArrayList<>(),
                        null,
                        null
    ...
    public static <T> TypeInformation<T> createHadoopWritableTypeInfo(Class<T> clazz) {
        ...
        Class<?> typeInfoClass;
        try {
            typeInfoClass = Class.forName(HADOOP_WRITABLE_TYPEINFO_CLASS,
                    false,
                    Thread.currentThread().getContextClassLoader()
            );
        } catch (ClassNotFoundException e) {
            throw new RuntimeException("Could not load the TypeInformation for the class '" + HADOOP_WRITABLE_CLASS
    ...
    static void validateIfWritable(TypeInformation<?> typeInfo, Type type) {
        try {
            ...
            Class<?> writableTypeInfoClass = Class.forName(HADOOP_WRITABLE_TYPEINFO_CLASS,
                    false,
            ...
            if (writableTypeInfoClass.isAssignableFrom(typeInfo.getClass())) {
                ...
                if (typeInfo.getTypeClass() != clazz) {
                    throw new InvalidTypesException(
                            "Writable type '" + typeInfo.getTypeClass().getCanonicalName() + "' expected but was '"
