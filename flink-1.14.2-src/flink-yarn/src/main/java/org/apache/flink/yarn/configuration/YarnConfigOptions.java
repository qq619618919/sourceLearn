...
public class YarnConfigOptions {
    ...
    public static final ConfigOption<Integer> APP_MASTER_VCORES = key("yarn.appmaster.vcores")
            .intType()
            .defaultValue(1)
     ...
     */
    public static final ConfigOption<UserJarInclusion> CLASSPATH_INCLUDE_USER_JAR = key(
            "yarn.per-job-cluster.include-user-jar")
            .enumType(UserJarInclusion.class)
            .defaultValue(ORDER)
            .withDescription("Defines whether user-jars are included in the system class path for per-job-clusters "
                    + "as well as their positioning in the path.");

    /** The vcores exposed by YARN. */
    public static final ConfigOption<Integer> VCORES = key("yarn.containers.vcores")
            .intType()
            .defaultValue(-1)
            .withDescription(Description
                    .builder()
                    .text("The number of virtual cores (vcores) per YARN container. By default, the number of vcores"
     ...
     * value.
     */
    public static final ConfigOption<String> APPLICATION_ATTEMPTS = key("yarn.application-attempts")
            .stringType()
            .noDefaultValue()
            .withDescription(Description
                    .builder()
                    .text("Number of ApplicationMaster restarts. By default, the value will be set to 1. "
                            ...
                            link("https://hadoop.apache.org/docs/stable/hadoop-yarn/hadoop-yarn-common/yarn-default.xml",
    ...
    public static final ConfigOption<Long> APPLICATION_ATTEMPT_FAILURE_VALIDITY_INTERVAL = key(
            ...
            .withDescription(Description
                    ...
                    .text("Time window in milliseconds which defines the number of application attempt failures when restarting the AM. "
                                    ...
                                    + "Set this value to -1 in order to count globally. " + "See %s for more information.",
                            link("https://hortonworks.com/blog/apache-hadoop-yarn-hdp-2-2-fault-tolerance-features-long-running-services/",
                                    "here"
                            )
                    )
                    .build());
    ...
    public static final ConfigOption<Integer> HEARTBEAT_DELAY_SECONDS = key("yarn.heartbeat.interval")
            .intType()
            .defaultValue(5)
     ...
     */
    public static final ConfigOption<Integer> CONTAINER_REQUEST_HEARTBEAT_INTERVAL_MILLISECONDS = key(
            ...
            .withDescription(new Description.DescriptionBuilder()
                    ...
                    .text("If you observe too many container allocations on the ResourceManager, then it is recommended to increase this value. See %s for more information.",
                            link("https://issues.apache.org/jira/browse/YARN-1902", "this link")
                    )
                    .build());
     ...
     */
    public static final ConfigOption<String> PROPERTIES_FILE_LOCATION = key("yarn.properties-file.location")
            .stringType()
            .noDefaultValue()
     ...
     */
    public static final ConfigOption<String> APPLICATION_MASTER_PORT = key("yarn.application-master.port")
            .stringType()
            .defaultValue("0")
            .withDescription(
     ...
     */
    public static final ConfigOption<Integer> APPLICATION_PRIORITY = key("yarn.application.priority")
            .intType()
            .defaultValue(-1)
            .withDescription(
                    "A non-negative integer indicating the priority for submitting a Flink YARN application. It"
     ...
     */
    public static final ConfigOption<Integer> FILE_REPLICATION = key("yarn.file-replication")
            .intType()
            .defaultValue(-1)
            .withDescription(
    ...
    public static final ConfigOption<String> APPLICATION_TAGS = key("yarn.tags")
            .stringType()
            .defaultValue("")
    ...
    public static final ConfigOption<String> STAGING_DIRECTORY = key("yarn.staging-directory")
            .stringType()
            .noDefaultValue()
            .withDescription(
    ...
    public static final ConfigOption<List<String>> SHIP_FILES = key("yarn.ship-files")
            .stringType()
            .asList()
            .noDefaultValue()
    ...
    public static final ConfigOption<List<String>> SHIP_ARCHIVES = key("yarn.ship-archives")
            .stringType()
            .asList()
            .noDefaultValue()
    ...
    public static final ConfigOption<String> FLINK_DIST_JAR = key("yarn.flink-dist-jar")
            .stringType()
            .noDefaultValue()
            .withDescription("The location of the Flink dist jar.");

    public static final ConfigOption<String> APPLICATION_ID = key("yarn.application.id")
            .stringType()
            .noDefaultValue()
    ...
    public static final ConfigOption<String> APPLICATION_QUEUE = key("yarn.application.queue")
            .stringType()
            .noDefaultValue()
            .withDescription("The YARN queue on which to put the current pipeline.");

    public static final ConfigOption<String> APPLICATION_NAME = key("yarn.application.name")
            .stringType()
            .noDefaultValue()
            .withDescription("A custom name for your YARN application.");

    public static final ConfigOption<String> APPLICATION_TYPE = key("yarn.application.type")
            .stringType()
            .noDefaultValue()
            .withDescription("A custom type for your YARN application..");

    public static final ConfigOption<String> NODE_LABEL = key("yarn.application.node-label")
            .stringType()
            .noDefaultValue()
            .withDescription("Specify YARN node label for the YARN application.");

    public static final ConfigOption<Boolean> SHIP_LOCAL_KEYTAB = key("yarn.security.kerberos.ship-local-keytab")
            .booleanType()
            .defaultValue(true)
            .withDescription("When this is true Flink will ship the keytab file configured via "
                    + SecurityOptions.KERBEROS_LOGIN_KEYTAB.key() + " as a localized YARN resource.");

    public static final ConfigOption<String> LOCALIZED_KEYTAB_PATH = key("yarn.security.kerberos.localized-keytab-path")
            .stringType()
            .defaultValue("krb5.keytab")
            .withDescription("Local (on NodeManager) path where kerberos keytab file will be" + " localized to. If "
                    + SHIP_LOCAL_KEYTAB.key() + " set to " + "true, Flink willl ship the keytab file as a YARN local "
    ...
    public static final ConfigOption<List<String>> PROVIDED_LIB_DIRS = key("yarn.provided.lib.dirs")
            .stringType()
            .asList()
            .noDefaultValue()
    ...
    public static final ConfigOption<List<String>> YARN_ACCESS = key("yarn.security.kerberos.additionalFileSystems")
            .stringType()
            .asList()
            .noDefaultValue()
            .withDescription(
    ...
    public static final ConfigOption<String> HADOOP_CONFIG_KEY = key("flink.hadoop.<key>")
            .stringType()
            .noDefaultValue()
            .withDescription(Description
                    .builder()
                    .text("A general option to probe Hadoop configuration through prefix 'flink.hadoop.'. Flink will remove the prefix to get <key> (from %s and %s) then set the <key> and value to Hadoop configuration."
                            ...
                            link("https://hadoop.apache.org/docs/stable/hadoop-project-dist/hadoop-common/core-default.xml",
                                    "core-default.xml"
                            ),
                            link("https://hadoop.apache.org/docs/stable/hadoop-project-dist/hadoop-hdfs/hdfs-default.xml",
                                    "hdfs-default.xml"
                            )
                    )
                    .build());
    ...
    @SuppressWarnings("unused")
    public static final ConfigOption<String> YARN_CONFIG_KEY = key("flink.yarn.<key>")
            .stringType()
            .noDefaultValue()
            .withDescription(Description
                    .builder()
                    .text("A general option to probe Yarn configuration through prefix 'flink.yarn.'. Flink will remove the prefix 'flink.' to get yarn.<key> (from %s) then set the yarn.<key> and value to Yarn configuration."
     ...
     */
    @SuppressWarnings("unused")
    public static final ConfigOption<String> EXTERNAL_RESOURCE_YARN_CONFIG_KEY = key(ExternalResourceOptions.genericKeyWithSuffix(
