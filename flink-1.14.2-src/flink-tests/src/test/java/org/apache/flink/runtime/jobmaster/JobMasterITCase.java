...
public class JobMasterITCase extends TestLogger {
    ...
    public void testRejectionOfEmptyJobGraphs() throws Exception {
        MiniClusterResource miniCluster = new MiniClusterResource(new MiniClusterResourceConfiguration.Builder()
    ...
    public void testJobManagerInitializationExceptionsAreForwardedToTheUser() {
        ...
        DataStream<String> stream = see.fromSource(mySource, WatermarkStrategy.noWatermarks(), "MySourceName");
    ...
    private static class FailOnInitializationSource implements Source<String, MockSplit, Void> {
        ...
        @Override
        public SplitEnumerator<MockSplit, Void> restoreEnumerator(SplitEnumeratorContext<MockSplit> enumContext,
