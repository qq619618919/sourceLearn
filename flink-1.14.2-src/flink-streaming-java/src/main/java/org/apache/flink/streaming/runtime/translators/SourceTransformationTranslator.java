...
public class SourceTransformationTranslator<OUT, SplitT extends SourceSplit, EnumChkT> extends SimpleTransformationTranslator<OUT, SourceTransformation<OUT, SplitT, EnumChkT>> {
    ...
    @Override
    protected Collection<Integer> translateForBatchInternal(final SourceTransformation<OUT, SplitT, EnumChkT> transformation,
                                                            final Context context) {

        return translateInternal(transformation,
                context,
                false /* don't emit progressive watermarks */);
    }

    @Override
    protected Collection<Integer> translateForStreamingInternal(final SourceTransformation<OUT, SplitT, EnumChkT> transformation,
                                                                final Context context) {
        /*************************************************
    ...
    private Collection<Integer> translateInternal(final SourceTransformation<OUT, SplitT, EnumChkT> transformation,
                                                  final Context context,
        ...
        SourceOperatorFactory<OUT> operatorFactory = new SourceOperatorFactory<>(transformation.getSource(),
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 给 StreamGraph 安上 SourceOperator（StreamNode）
         */
        streamGraph.addSource(transformationId,
                slotSharingGroup,
        ...
        streamGraph.setParallelism(transformationId,
                parallelism);
