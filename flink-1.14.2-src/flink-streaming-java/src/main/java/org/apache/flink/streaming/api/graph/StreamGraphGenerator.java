...
public class StreamGraphGenerator {
    ...
    public StreamGraphGenerator(final List<Transformation<?>> transformations,
    ...
    public StreamGraphGenerator setChangelogStateBackendEnabled(TernaryBoolean changelogStateBackendEnabled) {
    ...
    public StreamGraph generate() {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 构建 StreamGraph 中的 StreamNode 和 StreamEdge
         */
        ...
        // TODO_MA 马中华 注释： 作为结果返回
        final StreamGraph builtStreamGraph = streamGraph;

        // TODO_MA 马中华 注释： 清空相关数据结构
    ...
    private Collection<Integer> translate(final TransformationTranslator<?, Transformation<?>> translator,
    ...
    private static class ContextImpl implements TransformationTranslator.Context {
        ...
        public ContextImpl(final StreamGraphGenerator streamGraphGenerator,
