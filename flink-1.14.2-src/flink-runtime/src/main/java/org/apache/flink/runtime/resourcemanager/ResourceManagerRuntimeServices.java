...
public class ResourceManagerRuntimeServices {
    ...
    private static SlotManager createSlotManager(ResourceManagerRuntimeServicesConfiguration configuration,
                                                 ScheduledExecutor scheduledExecutor,
                                                 SlotManagerMetricGroup slotManagerMetricGroup) {
        ...
        if (configuration.isEnableFineGrainedResourceManagement()) {
            return new FineGrainedSlotManager(scheduledExecutor,
                    ...
                    new DefaultSlotStatusSyncer(slotManagerConfiguration.getTaskManagerRequestTimeout()),
                    new DefaultResourceAllocationStrategy(SlotManagerUtils.generateTaskManagerTotalResourceProfile(
             ...
             *  注释：
             */
            return new DeclarativeSlotManager(scheduledExecutor,
                    slotManagerConfiguration,
                    slotManagerMetricGroup,
                    new DefaultResourceTracker(),
