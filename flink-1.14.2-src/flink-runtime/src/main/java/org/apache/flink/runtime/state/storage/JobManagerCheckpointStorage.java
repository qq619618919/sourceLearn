...
public class JobManagerCheckpointStorage implements CheckpointStorage, ConfigurableCheckpointStorage {
    ...
    private JobManagerCheckpointStorage(JobManagerCheckpointStorage original, ReadableConfig config) {
        ...
        this.location = ExternalizedSnapshotLocation
                .newBuilder()
     ...
     */
    public static JobManagerCheckpointStorage createFromConfig(ReadableConfig config,
    ...
    public CheckpointStorageAccess createCheckpointStorage(JobID jobId) throws IOException {
         ...
         *  注释：
         */
        return new MemoryBackendCheckpointStorageAccess(jobId,
