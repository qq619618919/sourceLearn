...
public class FsStateBackend extends AbstractFileStateBackend implements ConfigurableStateBackend {
     ...
     *         are always asynchronous now.
     */
    public FsStateBackend(URI checkpointDirectory,
    ...
    private FsStateBackend(FsStateBackend original, ReadableConfig configuration, ClassLoader classLoader) {
        ...
        if (getValidFileStateThreshold(original.fileStateThreshold) >= 0) {
            ...
            final int configuredStateThreshold = getValidFileStateThreshold(configuration
                    .get(FS_SMALL_FILE_THRESHOLD)
                    .getBytes());
            ...
            if (configuredStateThreshold >= 0) {
                ...
                LoggerFactory
                        .getLogger(AbstractFileStateBackend.class)
    ...
    public int getMinFileSizeThreshold() {
        return fileStateThreshold >= 0 ? fileStateThreshold : MathUtils.checkedDownCast(FS_SMALL_FILE_THRESHOLD
                .defaultValue()
                .getBytes());
    }
    ...
    public CheckpointStorageAccess createCheckpointStorage(JobID jobId) throws IOException {
        ...
        return new FsCheckpointStorageAccess(getCheckpointPath(),
                getSavepointPath(),
                jobId,
    ...
    public String toString() {
        return "File State Backend (" + "checkpoints: '" + getCheckpointPath() + "', savepoints: '" + getSavepointPath()
