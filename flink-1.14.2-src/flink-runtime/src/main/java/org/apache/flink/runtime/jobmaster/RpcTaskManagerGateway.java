...
public class RpcTaskManagerGateway implements TaskManagerGateway {
    ...
    @Override
    public void notifyCheckpointComplete(ExecutionAttemptID executionAttemptID,
                                         JobID jobId,
                                         long checkpointId,
                                         long timestamp) {
    ...
    public void notifyCheckpointAborted(ExecutionAttemptID executionAttemptID,
                                        ...
                                        long timestamp) {
        taskExecutorGateway.abortCheckpoint(executionAttemptID, checkpointId, latestCompletedCheckpointId, timestamp);
    }
