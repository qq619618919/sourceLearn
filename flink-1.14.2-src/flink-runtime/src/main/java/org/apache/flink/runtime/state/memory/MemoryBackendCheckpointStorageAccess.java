...
public class MemoryBackendCheckpointStorageAccess extends AbstractFsCheckpointStorageAccess {
     ...
     */
    public MemoryBackendCheckpointStorageAccess(JobID jobId,
    ...
    public String toString() {
        return "MemoryBackendCheckpointStorage {" + "checkpointsDirectory=" + checkpointsDirectory + ", fileSystem="
                + fileSystem + ", maxStateSize=" + maxStateSize + '}';
    }
}
