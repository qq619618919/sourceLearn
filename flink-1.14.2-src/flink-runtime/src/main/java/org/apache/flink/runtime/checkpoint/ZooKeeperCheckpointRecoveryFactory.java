...
public class ZooKeeperCheckpointRecoveryFactory implements CheckpointRecoveryFactory {
    ...
    @Override
    public CompletedCheckpointStore createRecoveredCompletedCheckpointStore(JobID jobId,
                                                                            int maxNumberOfCheckpointsToRetain,
                                                                            ClassLoader userClassLoader) throws Exception {

        return ZooKeeperUtils.createCompletedCheckpoints(ZooKeeperUtils.useNamespaceAndEnsurePath(client,
                ZooKeeperUtils.getPathForJob(jobId)
        ), config, maxNumberOfCheckpointsToRetain, executor);
    }
