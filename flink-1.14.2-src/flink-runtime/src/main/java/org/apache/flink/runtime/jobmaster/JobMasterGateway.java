...
public interface JobMasterGateway extends CheckpointCoordinatorGateway, FencedRpcGateway<JobMasterId>, KvStateLocationOracle, KvStateRegistryGateway, JobMasterOperatorEventGateway {
     ...
     *         empty object.
     */
    CompletableFuture<SerializedInputSplit> requestNextInputSplit(final JobVertexID vertexID,
     ...
     */
    CompletableFuture<ExecutionState> requestPartitionState(final IntermediateDataSetID intermediateResultId,
     ...
     */
    CompletableFuture<Acknowledge> notifyPartitionDataAvailable(final ResultPartitionID partitionID,
     ...
     */
    CompletableFuture<Collection<SlotOffer>> offerSlots(final ResourceID taskManagerId,
     ...
     */
    CompletableFuture<Void> heartbeatFromTaskManager(final ResourceID resourceID,
     ...
     */
    CompletableFuture<String> triggerSavepoint(@Nullable final String targetDirectory,
     ...
     * @return Future which is completed with the savepoint path once completed
     */
    CompletableFuture<String> stopWithSavepoint(@Nullable final String targetDirectory,
