...
public enum CheckpointFailureReason {
    ...
    MINIMUM_TIME_BETWEEN_CHECKPOINTS(true,
    ...
    IO_EXCEPTION(true, "An Exception occurred while triggering the checkpoint. IO-problem detected."),
    ...
    CHECKPOINT_DECLINED_SUBSUMED(false,
    ...
    CHECKPOINT_DECLINED_ALIGNMENT_LIMIT_EXCEEDED(false,
