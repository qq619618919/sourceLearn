...
public enum ClientUtils {
    ...
    public static void extractAndUploadJobGraphFiles(JobGraph jobGraph,
        ...
        Collection<Tuple2<String, Path>> userArtifacts = jobGraph
                .getUserArtifacts()
                .entrySet()
                .stream()
    ...
    private static void uploadAndSetUserArtifacts(JobGraph jobGraph,
                                                  ...
                                                  BlobClient blobClient) throws IOException {
        Collection<Tuple2<String, PermanentBlobKey>> blobKeys = uploadUserArtifacts(jobGraph.getJobID(),
                artifactPaths,
                blobClient
        );
    ...
    private static Collection<Tuple2<String, PermanentBlobKey>> uploadUserArtifacts(JobID jobID,
