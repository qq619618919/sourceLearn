 ...
 *  注释： ExecutionGraph 中的 ExecutionJobVertex 的一个输出抽象
 */
public class IntermediateResult {
    ...
    private final Map<ConsumedPartitionGroup, MaybeOffloaded<ShuffleDescriptor[]>> shuffleDescriptorCache;

    public IntermediateResult(IntermediateDataSetID id,
    ...
    public IntermediateResultPartition getPartitionById(IntermediateResultPartitionID resultPartitionId) {
        ...
        Integer partitionNumber = partitionLookupHelper.get(checkNotNull(resultPartitionId,
    ...
    public void cacheShuffleDescriptors(ConsumedPartitionGroup consumedPartitionGroup,
