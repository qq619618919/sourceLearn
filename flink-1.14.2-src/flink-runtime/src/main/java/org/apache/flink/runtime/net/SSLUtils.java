...
public class SSLUtils {
    ...
    public static SSLHandlerFactory createInternalServerSSLEngineFactory(final Configuration config) throws Exception {
        ...
        return new SSLHandlerFactory(sslContext,
    ...
    private static KeyManagerFactory getKeyManagerFactory(Configuration config,
                                                          boolean internal,
        ...
        String keystoreFilePath = getAndCheckOption(config,
        ...
        String certPassword = getAndCheckOption(config,
     ...
     */
    @Nullable
    private static SslContext createInternalNettySSLContext(Configuration config,
                                                            boolean clientMode,
    ...
    @Nullable
    private static SslContext createRestNettySSLContext(Configuration config,
                                                        boolean clientMode,
     ...
     */
    @Nullable
    public static SslContext createRestNettySSLContext(Configuration config,
                                                       boolean clientMode,
                                                       ClientAuth clientAuth,
                                                       SslProvider provider) throws Exception {
        checkNotNull(config, "config");
    ...
    private static String getAndCheckOption(Configuration config,
        ...
        if (value != null) {
            ...
            throw new IllegalConfigurationException(
                    "The config option " + primaryOption.key() + " or " + fallbackOption.key() + " is missing.");
        }
    }
    ...
    private static class ConfiguringSSLServerSocketFactory extends ServerSocketFactory {
        ...
        ConfiguringSSLServerSocketFactory(SSLServerSocketFactory sslServerSocketFactory,
                                          String[] protocols,
                                          String[] cipherSuites) {
