...
public class HeapKeyedStateBackendBuilder<K> extends AbstractKeyedStateBackendBuilder<K> {
    ...
    public HeapKeyedStateBackendBuilder(TaskKvStateRegistry kvStateRegistry,
    ...
    public HeapKeyedStateBackend<K> build() throws BackendBuildingException {
        ...
        HeapSnapshotStrategy<K> snapshotStrategy = initSnapshotStrategy(registeredKVStates, registeredPQStates);
         ...
         *  注释：
         */
        return new HeapKeyedStateBackend<>(kvStateRegistry,
    ...
    private void restoreState(Map<String, StateTable<K, ?, ?>> registeredKVStates,
        ...
        if (firstHandle instanceof SavepointKeyedStateHandle) {
            ...
            restoreOperation = new HeapRestoreOperation<>(restoreStateHandles,
                    keySerializerProvider,
                    userCodeClassLoader,
                    registeredKVStates,
                    registeredPQStates,
    ...
    private HeapSnapshotStrategy<K> initSnapshotStrategy(Map<String, StateTable<K, ?, ?>> registeredKVStates,
                                                         Map<String, HeapPriorityQueueSnapshotRestoreWrapper<?>> registeredPQStates) {
        return new HeapSnapshotStrategy<>(registeredKVStates,
                registeredPQStates,
                keyGroupCompressionDecorator,
                localRecoveryConfig,
                keyGroupRange,
