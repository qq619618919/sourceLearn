...
public class DefaultJobLeaderService implements JobLeaderService {
    ...
    public DefaultJobLeaderService(UnresolvedTaskManagerLocation location,
    ...
    @Override
    public void start(final String initialOwnerAddress,
    ...
    private final class JobManagerLeaderListener implements LeaderRetrievalListener {
        ...
        private final class JobManagerRegisteredRpcConnection extends RegisteredRpcConnection<JobMasterId, JobMasterGateway, JMTMRegistrationSuccess, JMTMRegistrationRejection> {

            JobManagerRegisteredRpcConnection(Logger log,
    ...
    private static final class JobManagerRetryingRegistration extends RetryingRegistration<JobMasterId, JobMasterGateway, JMTMRegistrationSuccess, JMTMRegistrationRejection> {
        ...
        JobManagerRetryingRegistration(Logger log,
