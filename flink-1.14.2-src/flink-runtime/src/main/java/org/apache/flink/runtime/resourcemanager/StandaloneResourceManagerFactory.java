...
public final class StandaloneResourceManagerFactory extends ResourceManagerFactory<ResourceID> {
    ...
    @Override
    protected ResourceManager<ResourceID> createResourceManager(Configuration configuration,
        ...
        // TODO_MA 马中华 注释：
        final Time standaloneClusterStartupPeriodTime = ConfigurationUtils.getStandaloneClusterStartupPeriodTime(
                configuration);
         ...
         *  注释：
         */
        return new StandaloneResourceManager(rpcService,
                leaderSessionId,
                resourceId,
                heartbeatServices,
    ...
    protected ResourceManagerRuntimeServicesConfiguration createResourceManagerRuntimeServicesConfiguration(
        ...
        return ResourceManagerRuntimeServicesConfiguration.fromConfiguration(getConfigurationWithoutMaxSlotNumberIfSet(
