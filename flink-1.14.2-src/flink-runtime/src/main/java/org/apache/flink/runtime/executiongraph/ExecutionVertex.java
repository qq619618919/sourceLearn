...
public class ExecutionVertex implements AccessExecutionVertex, Archiveable<ArchivedExecutionVertex> {
    ...
    // TODO_MA 马中华 注释： 从属于哪个 ExecutionJobVertex
    private final ExecutionJobVertex jobVertex;

    /*************************************************
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： IntermediateResultPartition 集合
     */
    ...
    /*************************************************
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： 该 ExecutionVertex 顶点对应的 Task 部署抽象
     */
     ...
     */
    @VisibleForTesting
    public ExecutionVertex(ExecutionJobVertex jobVertex,
                           int subTaskIndex,
    ...
    public List<ConsumedPartitionGroup> getAllConsumedPartitionGroups() {
        return getExecutionGraphAccessor().getEdgeManager().getConsumedPartitionGroupsForVertex(executionVertexId);
    }
    ...
    private void resetForNewExecutionInternal(final long timestamp) {
        ...
        if (oldState.isTerminal()) {
            if (oldState == FINISHED) {
                ...
                getExecutionGraphAccessor().getPartitionGroupReleaseStrategy().vertexUnfinished(executionVertexId);
            }
