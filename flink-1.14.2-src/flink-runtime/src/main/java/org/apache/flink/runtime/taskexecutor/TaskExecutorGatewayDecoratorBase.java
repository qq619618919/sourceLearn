...
public class TaskExecutorGatewayDecoratorBase implements TaskExecutorGateway {
    ...
    @Override
    public CompletableFuture<Acknowledge> requestSlot(SlotID slotId,
                                                      JobID jobId,
                                                      ...
                                                      Time timeout) {
        return originalGateway.requestSlot(slotId,
                jobId,
                allocationId,
                resourceProfile,
                targetAddress,
    ...
    public CompletableFuture<Acknowledge> triggerCheckpoint(ExecutionAttemptID executionAttemptID,
        ...
        return originalGateway.triggerCheckpoint(executionAttemptID,
                checkpointID,
                checkpointTimestamp,
                checkpointOptions
        );
    ...
    public CompletableFuture<Acknowledge> confirmCheckpoint(ExecutionAttemptID executionAttemptID,
                                                            long checkpointId,
                                                            long checkpointTimestamp) {
        return originalGateway.confirmCheckpoint(executionAttemptID, checkpointId, checkpointTimestamp);
    }
    ...
    public CompletableFuture<Acknowledge> abortCheckpoint(ExecutionAttemptID executionAttemptID,
                                                          ...
                                                          long checkpointTimestamp) {
        return originalGateway.abortCheckpoint(executionAttemptID,
                checkpointId,
    ...
    @Override
    public CompletableFuture<Acknowledge> sendOperatorEventToTask(ExecutionAttemptID task,
                                                                  OperatorID operator,
    ...
    @Override
    public CompletableFuture<TaskThreadInfoResponse> requestThreadInfoSamples(ExecutionAttemptID taskExecutionAttemptId,
                                                                              ThreadInfoSamplesRequest requestParams,
                                                                              Time timeout) {
        return originalGateway.requestThreadInfoSamples(taskExecutionAttemptId, requestParams, timeout);
    }
}
