...
public class OperatorStateRestoreOperation implements RestoreOperation<Void> {
    ...
    public OperatorStateRestoreOperation(CloseableRegistry closeStreamOnCancelRegistry,
    ...
    public Void restore() throws Exception {
        ...
        for (OperatorStateHandle stateHandle : stateHandles) {
            ...
            try {
                ...
                OperatorBackendSerializationProxy backendSerializationProxy = new OperatorBackendSerializationProxy(
                        userClassloader);
                ...
                for (StateMetaInfoSnapshot restoredSnapshot : restoredOperatorMetaInfoSnapshots) {
                    ...
                    final RegisteredOperatorStateBackendMetaInfo<?> restoredMetaInfo = new RegisteredOperatorStateBackendMetaInfo<>(
                            restoredSnapshot);
                ...
                for (StateMetaInfoSnapshot restoredSnapshot : restoredBroadcastMetaInfoSnapshots) {
                    ...
                    final RegisteredBroadcastStateBackendMetaInfo<?, ?> restoredMetaInfo = new RegisteredBroadcastStateBackendMetaInfo<>(
                            restoredSnapshot);
                ...
                for (Map.Entry<String, OperatorStateHandle.StateMetaInfo> nameToOffsets : stateHandle
                    ...
                    if (listStateForName == null) {
                        BackendWritableBroadcastState<?, ?> broadcastStateForName = registeredBroadcastStates.get(
                                stateName);
                        Preconditions.checkState(broadcastStateForName != null,
    ...
    private <S> void deserializeOperatorStateValues(PartitionableListState<S> stateListForName,
    ...
    private <K, V> void deserializeBroadcastStateValues(final BackendWritableBroadcastState<K, V> broadcastStateForName,
