...
/**
 * // TODO_MA 马中华 注释： 管理相关心跳目标的心跳状态的心跳监视器。
 * Heartbeat monitor which manages the heartbeat state of the associated heartbeat target.
 * <p>
 * // TODO_MA 马中华 注释： 只要在指定的心跳超时间隔内没有看到心跳信号，监视器就会通知 {@link HeartbeatListener}。
 * The monitor notifies the {@link HeartbeatListener} whenever it has not seen a heartbeat signal
 * in the specified heartbeat timeout interval.
 * <p>
 * // TODO_MA 马中华 注释： 每个心跳信号都会重置此计时器。
