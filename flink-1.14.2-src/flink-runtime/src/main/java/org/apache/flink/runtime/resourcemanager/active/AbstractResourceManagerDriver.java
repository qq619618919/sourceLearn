...
public abstract class AbstractResourceManagerDriver<WorkerType extends ResourceIDRetrievable> implements ResourceManagerDriver<WorkerType> {
    ...
    public AbstractResourceManagerDriver(final Configuration flinkConfig, final Configuration flinkClientConfig) {
    ...
    @Override
    public final void initialize(ResourceEventHandler<WorkerType> resourceEventHandler,
