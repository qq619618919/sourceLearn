...
public class ZooKeeperLeaderRetrievalDriverFactory implements LeaderRetrievalDriverFactory {
    ...
    @Override
    public ZooKeeperLeaderRetrievalDriver createLeaderRetrievalDriver(LeaderRetrievalEventHandler leaderEventHandler,
         ...
         *  注释： 在构造方法中，启动监听
         */
        return new ZooKeeperLeaderRetrievalDriver(client,
                retrievalPath,
                leaderEventHandler,
