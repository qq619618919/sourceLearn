 ...
 * // TODO_MA 马中华 注释： 使用 ZK 的时候：
 * // TODO_MA 马中华 注释： 创建 删除 znode（把 ZK 当注册中心使用， 当分布式锁机制来使用） + 监听
 */
public interface HighAvailabilityServices extends ClientHighAvailabilityServices {
    ...
    default LeaderRetrievalService getWebMonitorLeaderRetriever() {
        throw new UnsupportedOperationException("getWebMonitorLeaderRetriever should no longer be used. Instead use "
