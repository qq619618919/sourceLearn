...
public class PermanentBlobCache extends AbstractBlobCache implements PermanentBlobService {
     ...
     *         not usable
     */
    public PermanentBlobCache(final Configuration blobClientConfig,
    ...
    public PermanentBlobCache(final Configuration blobClientConfig,
                              ...
                              BlobCacheSizeTracker blobCacheSizeTracker) throws IOException {
    ...
    private void checkLimitAndMoveFile(File incomingFile,
                                       JobID jobId,
                                       BlobKey blobKey,
                                       File localFile,
                                       Logger log,
        ...
        final List<Tuple2<JobID, BlobKey>> blobsToDelete = blobCacheSizeTracker.checkLimit(sizeOfIncomingFile);
