...
public abstract class RecordWriter<T extends IOReadableWritable> implements AvailabilityProvider {
    ...
    RecordWriter(ResultPartitionWriter writer, long timeout, String taskName) {
        ...
        if (timeout == -1 || timeout == 0) {
            ...
            String threadName = taskName == null ? DEFAULT_OUTPUT_FLUSH_THREAD_NAME :
    ...
    @VisibleForTesting
    public static ByteBuffer serializeRecord(DataOutputSerializer serializer,
    ...
    protected void checkErroneous() throws IOException {
        ...
        if (flusherException != null || (
                volatileFlusherExceptionCheckSkipCount >= VOLATILE_FLUSHER_EXCEPTION_MAX_CHECK_SKIP_COUNT
