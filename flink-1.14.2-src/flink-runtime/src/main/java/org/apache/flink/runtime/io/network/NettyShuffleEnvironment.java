...
public class NettyShuffleEnvironment implements ShuffleEnvironment<ResultPartition, SingleInputGate> {
    ...
    NettyShuffleEnvironment(ResourceID taskExecutorResourceId,
    ...
    @Override
    public ShuffleIOOwnerContext createShuffleIOOwnerContext(String ownerName,
    ...
    @Override
    public List<SingleInputGate> createInputGates(ShuffleIOOwnerContext ownerContext,
        ...
        synchronized (lock) {
            ...
            @SuppressWarnings("deprecation") InputChannelMetrics inputChannelMetrics = new InputChannelMetrics(
                    networkInputGroup,
                    ownerContext.getParentGroup()
            );

            // TODO_MA 马中华 注释： 声明一个数组
    ...
    @Deprecated
    public void registerLegacyNetworkMetrics(MetricGroup metricGroup,
                                             ResultPartitionWriter[] producedPartitions,
                                             InputGate[] inputGates) {
        NettyShuffleMetricFactory.registerLegacyNetworkMetrics(config.isNetworkDetailedMetrics(),
                metricGroup,
                producedPartitions,
                inputGates
        );
    ...
    @Override
    public boolean updatePartitionInfo(ExecutionAttemptID consumerID,
