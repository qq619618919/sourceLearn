...
public abstract class InputChannel {
    ...
    protected InputChannel(SingleInputGate inputGate,
                           int channelIndex,
    ...
    public static final class BufferAndAvailability {
        ...
        public BufferAndAvailability(Buffer buffer,
        ...
        public String toString() {
            return "BufferAndAvailability{" + "buffer=" + buffer + ", nextDataType=" + nextDataType
                    + ", buffersInBacklog=" + buffersInBacklog + ", sequenceNumber=" + sequenceNumber + '}';
        }
    }
