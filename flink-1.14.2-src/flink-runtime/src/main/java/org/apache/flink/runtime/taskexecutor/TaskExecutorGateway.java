...
public interface TaskExecutorGateway extends RpcGateway, TaskExecutorOperatorEventGateway, TaskExecutorThreadInfoGateway {
     ...
     */
    CompletableFuture<Acknowledge> requestSlot(SlotID slotId,
                                               JobID jobId,
     ...
     */
    CompletableFuture<Acknowledge> submitTask(TaskDeploymentDescriptor tdd,
     ...
     */
    CompletableFuture<Acknowledge> releaseClusterPartitions(Collection<IntermediateDataSetID> dataSetsToRelease,
                                                            @RpcTimeout Time timeout);
     ...
     */
    CompletableFuture<Acknowledge> confirmCheckpoint(ExecutionAttemptID executionAttemptID,
                                                     long checkpointId,
                                                     long checkpointTimestamp);
     ...
     * @return Future acknowledge if the checkpoint has been successfully confirmed
     */
    CompletableFuture<Acknowledge> abortCheckpoint(ExecutionAttemptID executionAttemptID,
                                                   long checkpointId,
     ...
     */
    CompletableFuture<Acknowledge> freeSlot(final AllocationID allocationId,
