...
public final class SnapshotStrategyRunner<T extends StateObject, SR extends SnapshotResources> {
    ...
    public SnapshotStrategyRunner(@Nonnull String description,
    ...
    @Nonnull
    public final RunnableFuture<SnapshotResult<T>> snapshot(long checkpointId,
                                                            long timestamp,
         ...
         *  注释： SavepointSnapshotStrategy
         */
        SnapshotStrategy.SnapshotResultSupplier<T> asyncSnapshot = snapshotStrategy.asyncSnapshot(snapshotResources,
                checkpointId,
                timestamp,
                streamFactory,
                checkpointOptions
    ...
    private void logCompletedInternal(@Nonnull String template,
