...
class SlotSharingExecutionSlotAllocator implements ExecutionSlotAllocator {
    ...
    SlotSharingExecutionSlotAllocator(PhysicalSlotProvider slotProvider,
     ...
     */
    @Override
    public List<SlotExecutionVertexAssignment> allocateSlotsFor(List<ExecutionVertexID> executionVertexIds) {

        SharedSlotProfileRetriever sharedSlotProfileRetriever = sharedSlotProfileRetrieverFactory.createFromBulk(new HashSet<>(
                executionVertexIds));
    ...
    private void cancelLogicalSlotRequest(ExecutionVertexID executionVertexId,
                                          Throwable cause) {
        ExecutionSlotSharingGroup executionSlotSharingGroup = slotSharingStrategy.getExecutionSlotSharingGroup(
                executionVertexId);
        ...
        if (slot != null) {
            ...
            LOG.debug("There is no SharedSlot for ExecutionSlotSharingGroup of ExecutionVertexID {}",
                    executionVertexId
            );
        }
    }

    private static Map<ExecutionVertexID, SlotExecutionVertexAssignment> allocateLogicalSlotsFromSharedSlots(Map<ExecutionSlotSharingGroup, SharedSlot> slots,
    ...
    private SharedSlot getOrAllocateSharedSlot(ExecutionSlotSharingGroup executionSlotSharingGroup,
        ...
        return sharedSlots.computeIfAbsent(executionSlotSharingGroup, group -> {
             ...
             *  注释：
             */
            PhysicalSlotRequest physicalSlotRequest = new PhysicalSlotRequest(physicalSlotRequestId,
                    slotProfile,  // TODO_MA 马中华 注释： 资源配置
            ...
            // TODO_MA 马中华 注释： 其实就是封装了 PhysicalSlot
    ...
    private SharingPhysicalSlotRequestBulk createBulk(Map<ExecutionSlotSharingGroup, SharedSlot> slots,
        ...
        SharingPhysicalSlotRequestBulk bulk = new SharingPhysicalSlotRequestBulk(executions,
                pendingRequests,
