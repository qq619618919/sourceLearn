...
interface ChannelStateWriteRequest {
    ...
    static ChannelStateWriteRequest write(long checkpointId,
        ...
        return buildWriteRequest(checkpointId,
                "writeInput",
                iterator,
    ...
    static ChannelStateWriteRequest buildWriteRequest(long checkpointId,
                                                      String name,
                                                      CloseableIterator<Buffer> iterator,
...
final class CheckpointStartRequest implements ChannelStateWriteRequest {
    ...
    CheckpointStartRequest(long checkpointId,
                           ChannelStateWriteResult targetResult,
                           CheckpointStorageLocationReference locationReference) {
...
final class CheckpointInProgressRequest implements ChannelStateWriteRequest {
    ...
    CheckpointInProgressRequest(String name,
                                long checkpointId,
