...
public class ChannelStateWriterImpl implements ChannelStateWriter {
    ...
    private static final int DEFAULT_MAX_CHECKPOINTS = 1000; // includes max-concurrent-checkpoints + checkpoints to be aborted (scheduled via
    // mailbox)
     ...
     * #maxCheckpoints}.
     */
    public ChannelStateWriterImpl(String taskName,
                                  int subtaskIndex,
    ...
    ChannelStateWriterImpl(String taskName,
        ...
        this(taskName,
                ...
                new ChannelStateWriteRequestExecutorImpl(taskName,
                        new ChannelStateWriteRequestDispatcherImpl(taskName,
                                subtaskIndex,
    ...
    public void start(long checkpointId, CheckpointOptions checkpointOptions) {
        ...
        ChannelStateWriteResult put = results.computeIfAbsent(checkpointId, id -> {
            Preconditions.checkState(results.size() < maxCheckpoints,
                    String.format("%s can't start %d, results.size() > maxCheckpoints: %d > %d",
                            taskName,
                            checkpointId,
                            results.size(),
                            maxCheckpoints
        ...
        Preconditions.checkArgument(put == result,
    ...
    public void addInputData(long checkpointId,
        ...
        LOG.trace("{} adding input data, checkpoint {}, channel: {}, startSeqNum: {}",
                taskName,
                checkpointId,
                info,
                startSeqNum
    ...
    public void addOutputData(long checkpointId, ResultSubpartitionInfo info, int startSeqNum, Buffer... data) {
        LOG.trace("{} adding output data, checkpoint {}, channel: {}, startSeqNum: {}, num buffers: {}",
                taskName,
                checkpointId,
                info,
                startSeqNum,
