...
public interface ResourceManagerGateway extends FencedRpcGateway<ResourceManagerId>, ClusterPartitionManager {
     ...
     */
    CompletableFuture<RegistrationResponse> registerJobManager(JobMasterId jobMasterId,
     ...
     */
    CompletableFuture<RegistrationResponse> registerTaskExecutor(TaskExecutorRegistration taskExecutorRegistration,
                                                                 @RpcTimeout Time timeout);
     ...
     */
    CompletableFuture<Void> heartbeatFromTaskManager(final ResourceID heartbeatOrigin,
     ...
     */
    CompletableFuture<TransientBlobKey> requestTaskManagerFileUploadByType(ResourceID taskManagerId,
                                                                           FileType fileType,
                                                                           @RpcTimeout Time timeout);
     ...
     *         to the {@link BlobServer}.
     */
    CompletableFuture<TransientBlobKey> requestTaskManagerFileUploadByName(ResourceID taskManagerId,
                                                                           String fileName,
                                                                           @RpcTimeout Time timeout);
     ...
     */
    CompletableFuture<Collection<LogInfo>> requestTaskManagerLogList(ResourceID taskManagerId,
                                                                     @RpcTimeout Time timeout);
     ...
     */
    CompletableFuture<TaskExecutorThreadInfoGateway> requestTaskExecutorThreadInfoGateway(ResourceID taskManagerId,
                                                                                          @RpcTimeout Time timeout);
}
