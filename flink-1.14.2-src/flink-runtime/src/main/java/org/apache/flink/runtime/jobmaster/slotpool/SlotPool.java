...
public interface SlotPool extends AllocatedSlotActions, AutoCloseable {
     ...
     */
    boolean releaseTaskManager(final ResourceID resourceId,
     ...
     */
    Optional<PhysicalSlot> allocateAvailableSlot(@Nonnull SlotRequestId slotRequestId,
     ...
     */
    @Nonnull
    CompletableFuture<PhysicalSlot> requestNewAllocatedSlot(@Nonnull SlotRequestId slotRequestId,
     ...
     */
    @Nonnull
    CompletableFuture<PhysicalSlot> requestNewAllocatedBatchSlot(@Nonnull SlotRequestId slotRequestId,
                                                                 @Nonnull ResourceProfile resourceProfile);
