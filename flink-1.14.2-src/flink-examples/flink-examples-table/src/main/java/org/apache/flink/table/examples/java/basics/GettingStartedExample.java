...
public final class GettingStartedExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // name columns
        final Table namedCustomers = truncatedCustomers.as("name",
                "date_of_birth",
                "street",
                "zip_code",
                "city",
        ...
        env
                .sqlQuery("SELECT " + "  COUNT(*) AS `number of customers`, "
                        + "  AVG(YEAR(date_of_birth)) AS `average birth year` " + "FROM `customers`")
                .execute()
                .print();
        ...
        try (CloseableIterator<Row> iterator = youngCustomers.execute().collect()) {
            ...
            expectedOutput.add(Row.of("GUILLERMO SMITH",
                    LocalDate.parse("1992-12-12"),
            ...
            expectedOutput.add(Row.of("ELLEN ORTEGA",
                    LocalDate.parse("1985-06-18"),
