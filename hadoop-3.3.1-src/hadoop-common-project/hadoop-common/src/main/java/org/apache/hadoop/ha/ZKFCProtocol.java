...
public interface ZKFCProtocol {
    // TODO_MA 马中华 注释： 这个是   admin 和 ZKFC 之间的通信协议
    // TODO_MA 马中华 注释： 管理员： hdfs haadmin -transitionToActive nn1　
     ...
     */
    // TODO_MA 马中华 注释： 简单说： 退出 active
    // TODO_MA 马中华 注释：  假设命令是切换成 standby 那么就说明最终调用的方法就是这个
    @Idempotent
     ...
     * @throws AccessControlException if the operation is disallowed
     */
    // TODO_MA 马中华 注释： 优雅故障转移，成为新的 active
    // TODO_MA 马中华 注释： 让 anmenode 切换状态为 active 的
    // TODO_MA 马中华 注释： hdfs haadmin -transitToActive nn1
    @Idempotent
    public void gracefulFailover() throws IOException, AccessControlException;

//    最底层还是调用 becomeActive()
}
