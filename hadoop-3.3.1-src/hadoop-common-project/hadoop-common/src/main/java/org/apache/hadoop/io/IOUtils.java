...
public class IOUtils {
    ...
    public static void copyBytes(InputStream in, OutputStream out, int buffSize, boolean close) throws IOException {
        try {
             ...
             *  注释： buffSize = io.file.buffer.size = 4096 = 4kb
             */
    ...
    public static void copyBytes(InputStream in, OutputStream out, int buffSize) throws IOException {
        ...
        while (bytesRead >= 0) {
            ...
            // TODO_MA 马中华 注释： 往输出流写
            // TODO_MA 马中华 注释： out = HdfsDataOutputStream
            // TODO_MA 马中华 注释： HdfsDataOutputStream 是 FSDataOutputStream 是 DataOutputStream 的子类
            // TODO_MA 马中华 注释： HdfsDataOutputStream 内部包装了 DFSOutputStream
            // TODO_MA 马中华 注释： out 的内部是 PositionCache
    ...
    public static void copyBytes(InputStream in, OutputStream out, Configuration conf, boolean close) throws IOException {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： io.file.buffer.size = 4096 = 4kb
         */
    ...
    public static IOException wrapException(final String path, final String methodName, final IOException exception) {
        ...
        if (exception instanceof InterruptedIOException || exception instanceof PathIOException) {
            ...
            String msg = String.format("Failed with %s while processing file/directory :[%s] in " + "method:[%s]",
