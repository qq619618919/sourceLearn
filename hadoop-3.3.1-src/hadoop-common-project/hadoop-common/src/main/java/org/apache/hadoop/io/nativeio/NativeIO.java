...
public class NativeIO {
    ...
    /* Wait upon writeout of all pages
       ...
       write.  */
        ...
        static {
            if (NativeCodeLoader.isNativeCodeLoaded()) {
                try {
                    ...
                    LOG.debug(
                            "Initialized cache for IDs to User/Group mapping with a " + " cache timeout of " + cacheTimeout / 1000 + " seconds.");
         ...
         */
        static void posixFadviseIfPossible(String identifier, FileDescriptor fd, long offset, long len,
                                           int flags) throws NativeIOException {
