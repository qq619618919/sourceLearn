...
public final class ShutdownHookManager {
    ...
    private static final ExecutorService EXECUTOR = HadoopExecutors.newSingleThreadExecutor(
        ...
        try {
            Runtime.getRuntime().addShutdownHook(new Thread() {
                ...
                public void run() {
                    ...
                    LOG.debug(String.format("Completed shutdown in %.3f seconds; Timeouts: %d", (ended - started) / 1000.0,
                            timeoutCount
                    ));
    ...
    private static void shutdownExecutor(final Configuration conf) {
        try {
            ...
            // interrupted.
            LOG.error("ShutdownHookManager interrupted while waiting for " + "termination.", ex);
            EXECUTOR.shutdownNow();
    ...
    /**
     * // TODO_MA 马中华 注释： 提供唯一的方式访问或者获取这个 单一实例
