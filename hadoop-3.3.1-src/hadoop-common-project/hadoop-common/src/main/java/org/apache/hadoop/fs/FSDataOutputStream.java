...
public class FSDataOutputStream extends DataOutputStream implements Syncable, CanSetDropBehind, StreamCapabilities, IOStatisticsSource, Abortable {
    ...
    private static class PositionCache extends FilterOutputStream {
        ...
        PositionCache(OutputStream out, FileSystem.Statistics stats, long pos) {
            // TODO_MA 马中华 注释： out = DFSOutputStream
            super(out);
            statistics = stats;
            position = pos;
        }
        ...
        public void write(byte b[], int off, int len) throws IOException {
             ...
             *  注释： out = DFSOutputStream
             *  DFSOutputStream 是 FSOutputSummer 的子类
             */
            out.write(b, off, len);
    ...
    public FSDataOutputStream(OutputStream out, FileSystem.Statistics stats, long startPosition) {
         ...
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： out = DFSOutputStream
         *  将 DFSOutputStream 包装成 PositionCache
         */
    ...
    public AbortableResult abort() {
        if (wrappedStream instanceof Abortable) {
            ...
            throw new UnsupportedOperationException(FSExceptionMessages.ABORTABLE_UNSUPPORTED);
        }
    }
}
