...
public class CommonConfigurationKeysPublic {
     ...
     * Default value: {@value}.
     */
    public static final String FS_CREATION_PARALLEL_COUNT = "fs.creation.parallel.count";
     ...
     * Default value: {@value}.
     */
    public static final int FS_CREATION_PARALLEL_COUNT_DEFAULT = 64;
    ...
    public static final String HADOOP_SECURITY_SENSITIVE_CONFIG_KEYS_DEFAULT = String.join(",", "secret$", "password$",
            "ssl.keystore.pass$", "fs.s3.*[Ss]ecret.?[Kk]ey", "fs.s3a.*.server-side-encryption.key",
            "fs.azure\\.account.key.*", "credential$", "oauth.*secret", "oauth.*password", "oauth.*token",
     ...
     * core-default.xml</a>
     */
    public static final String HADOOP_HTTP_IDLE_TIMEOUT_MS_KEY = "hadoop.http.idle_timeout.ms";
