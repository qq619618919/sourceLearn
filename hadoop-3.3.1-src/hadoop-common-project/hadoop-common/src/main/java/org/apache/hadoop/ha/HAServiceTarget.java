...
public abstract class HAServiceTarget {
    ...
    private HAServiceProtocol getProxyForAddress(Configuration conf, int timeoutMs,
    ...
    private HAServiceProtocol getProxyForAddress(Configuration conf, int timeoutMs, int retries,
                                                 InetSocketAddress addr) throws IOException {
