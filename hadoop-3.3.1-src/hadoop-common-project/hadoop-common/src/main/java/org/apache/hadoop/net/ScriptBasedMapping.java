    ...
    protected static class RawScriptBasedMapping extends AbstractDNSToSwitchMapping {
        ...
        public List<String> resolve(List<String> names) {
            ...
            if (output != null) {
                ...
                if (m.size() != names.size()) {
                    ...
                    LOG.error("Script " + scriptName + " returned " + Integer.toString(
        ...
        protected String runResolveCommand(List<String> args, String commandScriptName) {
            ...
            if (maxArgs < MIN_ALLOWABLE_ARGS) {
                LOG.warn("Invalid value " + Integer.toString(
                        maxArgs) + " for " + SCRIPT_ARG_COUNT_KEY + "; must be >= " + Integer.toString(MIN_ALLOWABLE_ARGS));
                return null;
            }
