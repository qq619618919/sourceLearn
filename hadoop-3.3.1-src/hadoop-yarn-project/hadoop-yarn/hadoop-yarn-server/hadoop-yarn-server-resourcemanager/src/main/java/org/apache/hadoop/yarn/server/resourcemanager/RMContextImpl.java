...
public class RMContextImpl implements RMContext {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RMContextImpl.class);
    ...
    public RMContextImpl(Dispatcher rmDispatcher, ContainerAllocationExpirer containerAllocationExpirer,
        ...
        setActiveServiceContext(
                new RMActiveServiceContext(rmDispatcher, containerAllocationExpirer, amLivelinessMonitor, amFinishingMonitor,
                        delegationTokenRenewer, appTokenSecretManager, containerTokenSecretManager, nmTokenSecretManager,
                        clientToAMTokenSecretManager, scheduler
                ));
    ...
    public RMContextImpl(Dispatcher rmDispatcher, ContainerAllocationExpirer containerAllocationExpirer,
        ...
        this(rmDispatcher, containerAllocationExpirer, amLivelinessMonitor, amFinishingMonitor, delegationTokenRenewer,
                appTokenSecretManager, containerTokenSecretManager, nmTokenSecretManager, clientToAMTokenSecretManager, null
        );
    }
    ...
    public void setPlacementConstraintManager(PlacementConstraintManager placementConstraintManager) {
        activeServiceContext.setPlacementConstraintManager(placementConstraintManager);
    }
    ...
    public ConcurrentMap<ApplicationId, SystemCredentialsForAppsProto> getSystemCredentialsForApps() {
    ...
    public String getAppProxyUrl(Configuration conf, ApplicationId applicationId) {
        try {
            ...
            URI proxyUri = ProxyUriUtils.getUriFromAMUrl(scheme, getProxyHostAndPort(conf));
