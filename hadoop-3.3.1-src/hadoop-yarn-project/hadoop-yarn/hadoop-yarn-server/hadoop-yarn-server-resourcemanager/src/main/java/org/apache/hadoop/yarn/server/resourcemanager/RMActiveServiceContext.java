...
public class RMActiveServiceContext {
    ...
    private final ConcurrentMap<ApplicationId, SystemCredentialsForAppsProto> systemCredentials = new ConcurrentHashMap<ApplicationId, SystemCredentialsForAppsProto>();
    ...
    @Private
    @Unstable
    public RMActiveServiceContext(Dispatcher rmDispatcher, ContainerAllocationExpirer containerAllocationExpirer,
