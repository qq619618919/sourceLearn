...
public class NodeHeartbeatResponsePBImpl extends NodeHeartbeatResponse {
    private NodeHeartbeatResponseProto proto = NodeHeartbeatResponseProto.getDefaultInstance();
    ...
    private void addAppCollectorsMapToProto() {
        ...
        for (Map.Entry<ApplicationId, AppCollectorData> entry : appCollectorsMap.entrySet()) {
            ...
            AppCollectorDataProto.Builder appCollectorDataBuilder = AppCollectorDataProto.newBuilder()
                    .setAppId(ProtoUtils.convertToProtoFormat(entry.getKey())).setAppCollectorAddr(data.getCollectorAddr())
                    .setRmIdentifier(data.getRMIdentifier()).setVersion(data.getVersion());
    ...
    @Override
    public void addAllContainersToUpdate(final Collection<Container> containersToBeUpdated) {
    ...
    @Override
    public void addAllContainersToDecrease(final Collection<Container> containersToDecrease) {
    ...
    private void initAppCollectorsMap() {
        ...
        if (!list.isEmpty()) {
            ...
            for (AppCollectorDataProto c : list) {
                ...
                AppCollectorData data = AppCollectorData.newInstance(appId, c.getAppCollectorAddr(), c.getRmIdentifier(),
                        c.getVersion(), collectorToken
                );
    ...
    @Override
    public void setSystemCredentialsForApps(Collection<SystemCredentialsForAppsProto> systemCredentialsForAppsProto) {
        maybeInitBuilder();
    ...
    @Override
    public Collection<SystemCredentialsForAppsProto> getSystemCredentialsForApps() {
        NodeHeartbeatResponseProtoOrBuilder p = viaProto ? proto : builder;
        return p.getSystemCredentialsForAppsList();
    }

    @Override
    public void setAppCollectors(Map<ApplicationId, AppCollectorData> appCollectors) {
    ...
    @Override
    public void setAreNodeAttributesAcceptedByRM(boolean areNodeAttributesAcceptedByRM) {
        maybeInitBuilder();
    ...
    @Override
    public void addAllContainersToSignal(final List<SignalContainerRequest> containersToSignal) {
    ...
    private ContainerQueuingLimit convertFromProtoFormat(ContainerQueuingLimitProto p) {
        return new ContainerQueuingLimitPBImpl(p);
    }

    private ContainerQueuingLimitProto convertToProtoFormat(ContainerQueuingLimit c) {
        return ((ContainerQueuingLimitPBImpl) c).getProto();
    }

    private SignalContainerRequestPBImpl convertFromProtoFormat(SignalContainerRequestProto p) {
        return new SignalContainerRequestPBImpl(p);
    }

    private SignalContainerRequestProto convertToProtoFormat(SignalContainerRequest t) {
