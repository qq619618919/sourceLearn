...
public class NodeStatusPBImpl extends NodeStatus {
    ...
    private synchronized void addKeepAliveApplicationsToProto() {
        ...
        if (keepAliveApplications == null) return;
    ...
    public synchronized void setNodeId(NodeId nodeId) {
        maybeInitBuilder();
        if (nodeId == null) builder.clearNodeId();
        this.nodeId = nodeId;
    ...
    @Override
    public synchronized void setContainersUtilization(ResourceUtilization containersUtilization) {
        maybeInitBuilder();
    ...
    @Override
    public synchronized void setNodeUtilization(ResourceUtilization nodeUtilization) {
        maybeInitBuilder();
    ...
    @Override
    public synchronized void setIncreasedContainers(List<Container> increasedContainers) {
        maybeInitBuilder();
        if (increasedContainers == null) {
            builder.clearIncreasedContainers();
            return;
    ...
    @Override
    public synchronized OpportunisticContainersStatus getOpportunisticContainersStatus() {
        NodeStatusProtoOrBuilder p = this.viaProto ? this.proto : this.builder;
    ...
    @Override
    public synchronized void setOpportunisticContainersStatus(OpportunisticContainersStatus opportunisticContainersStatus) {
        maybeInitBuilder();
    ...
    private NodeHealthStatusProto convertToProtoFormat(NodeHealthStatus healthStatus) {
    ...
    private OpportunisticContainersStatusProto convertToProtoFormat(OpportunisticContainersStatus r) {
        return ((OpportunisticContainersStatusPBImpl) r).getProto();
    }

    private OpportunisticContainersStatus convertFromProtoFormat(OpportunisticContainersStatusProto p) {
        return new OpportunisticContainersStatusPBImpl(p);
    }

    private ContainerPBImpl convertFromProtoFormat(ContainerProto c) {
        return new ContainerPBImpl(c);
    }

    private ContainerProto convertToProtoFormat(Container c) {
