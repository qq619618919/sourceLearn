...
public class ClientRMProxy<T> extends RMProxy<T> {
    private static final Logger LOG = LoggerFactory.getLogger(ClientRMProxy.class);
    ...
    public InetSocketAddress getRMAddress(YarnConfiguration conf, Class<?> protocol) throws IOException {
        if (protocol == ApplicationClientProtocol.class) {
            ...
            return conf.getSocketAddr(YarnConfiguration.RM_ADMIN_ADDRESS, YarnConfiguration.DEFAULT_RM_ADMIN_ADDRESS,
    ...
    public static Text getRMDelegationTokenService(Configuration conf) {
        return getTokenService(conf, YarnConfiguration.RM_ADDRESS, YarnConfiguration.DEFAULT_RM_ADDRESS,
                YarnConfiguration.DEFAULT_RM_PORT
        );
    }
    ...
    public static Text getAMRMTokenService(Configuration conf) {
        return getTokenService(conf, YarnConfiguration.RM_SCHEDULER_ADDRESS, YarnConfiguration.DEFAULT_RM_SCHEDULER_ADDRESS,
                YarnConfiguration.DEFAULT_RM_SCHEDULER_PORT
        );
    }
