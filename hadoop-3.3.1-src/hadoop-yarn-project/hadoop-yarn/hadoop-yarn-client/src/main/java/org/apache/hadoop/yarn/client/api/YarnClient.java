...
public abstract class YarnClient extends AbstractService {
     ...
     */
    public abstract void failApplicationAttempt(ApplicationAttemptId applicationAttemptId) throws YarnException, IOException;
     ...
     * @throws IOException
     */
    public abstract List<ApplicationReport> getApplications(Set<String> queues, Set<String> users, Set<String> applicationTypes,
                                                            EnumSet<YarnApplicationState> applicationStates) throws YarnException, IOException;
    ...
    public List<ApplicationReport> getApplications(GetApplicationsRequest request) throws YarnException, IOException {
        throw new UnsupportedOperationException(
                "The sub-class extending " + YarnClient.class.getName() + " is expected to implement this !");
    }
    ...
    @Public
    @Unstable
    public abstract ReservationUpdateResponse updateReservation(ReservationUpdateRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract ReservationDeleteResponse deleteReservation(ReservationDeleteRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract ReservationListResponse listReservations(ReservationListRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract Map<String, Set<NodeId>> getLabelsToNodes(Set<String> labels) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract Priority updateApplicationPriority(ApplicationId applicationId,
    ...
    @Public
    @Unstable
    public abstract Map<String, Resource> getResourceProfiles() throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract Resource getResourceProfile(String profile) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract List<ResourceTypeInfo> getResourceTypeInfo() throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract Set<NodeAttributeInfo> getClusterAttributes() throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract Map<String, Set<NodeAttribute>> getNodeToAttributes(Set<String> hostNames) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    public abstract void shellToContainer(ContainerId containerId, ShellContainerCommand command) throws IOException;
