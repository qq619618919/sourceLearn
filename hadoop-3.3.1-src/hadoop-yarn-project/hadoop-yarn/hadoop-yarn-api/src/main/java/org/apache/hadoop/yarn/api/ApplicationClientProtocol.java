...
public interface ApplicationClientProtocol extends ApplicationBaseProtocol {
    ...
    @Unstable
    @Idempotent
    GetNewReservationResponse getNewReservation(GetNewReservationRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    ReservationListResponse listReservations(ReservationListRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    SignalContainerResponse signalToContainer(SignalContainerRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    GetResourceProfileResponse getResourceProfile(GetResourceProfileRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    GetAttributesToNodesResponse getAttributesToNodes(GetAttributesToNodesRequest request) throws YarnException, IOException;
    ...
    @Public
    @Unstable
    GetNodesToAttributesResponse getNodesToAttributes(GetNodesToAttributesRequest request) throws YarnException, IOException;
}
