...
class PseudoLocalFs extends FileSystem {
    ...
    @Override
    public FSDataOutputStream create(Path path, FsPermission permission, boolean overwrite, int bufferSize, short replication,
     ...
     */
    static class RandomInputStream extends InputStream implements Seekable, PositionedReadable {
