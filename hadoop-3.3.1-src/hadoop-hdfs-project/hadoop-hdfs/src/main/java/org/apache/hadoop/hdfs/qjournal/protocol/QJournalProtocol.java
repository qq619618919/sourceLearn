...
public interface QJournalProtocol {
     ...
     */
    NewEpochResponseProto newEpoch(String journalId, String nameServiceId, NamespaceInfo nsInfo,
     ...
     * // TODO_MA 马中华 注释： NameNode 通过 JournalProtocol 通信协议向 JournalNode 发送日志
     */
     ...
     */
    GetEditLogManifestResponseProto getEditLogManifest(String jid, String nameServiceId, long sinceTxId,
     ...
     */
    GetJournaledEditsResponseProto getJournaledEdits(String jid, String nameServiceId, long sinceTxId,
    ...
    Boolean canRollBack(String journalId, String nameServiceid, StorageInfo storage, StorageInfo prevStorage,
