...
class ReplicationWork extends BlockReconstructionWork {
    ...
    public ReplicationWork(BlockInfo block, BlockCollection bc, DatanodeDescriptor[] srcNodes,
    ...
    @Override
    void chooseTargets(BlockPlacementPolicy blockplacement, BlockStoragePolicySuite storagePolicySuite,
        ...
        try {
            ...
            if (getBlock().getNumBytes() != BlockCommand.NO_ACK) {
                 ...
                 *  注释：
                 */
                chosenTargets = blockplacement.chooseTarget(getSrcPath(), getAdditionalReplRequired(), getSrcNodes()[0],
