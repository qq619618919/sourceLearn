...
public class JournalNodeRpcServer implements QJournalProtocol, InterQJournalProtocol {
    ...
    // TODO_MA 马中华 注释： QJournalProtocol ===> NameNode + JournalNode
    // TODO_MA 马中华 注释： InterQJournalProtocol  ====> JournalNode + JournalNode

    // TODO_MA 马中华 注释： QJournalProtocol 协议中，定义了一个方法 journal： anmenode 向 journalnode 发送 日志
    ...
    JournalNodeRpcServer(Configuration conf, JournalNode jn) throws IOException {
        ...
        // TODO_MA 马中华 注释： 地址和端口号： 0.0.0.0:8485
        // TODO_MA 马中华 注释： dfs.journalnode.rpc-bind-host
        ...
        this.server = new RPC.Builder(confCopy).setProtocol(QJournalProtocolPB.class).setInstance(service)
                .setBindAddress(bindHost).setPort(addr.getPort()).setNumHandlers(HANDLER_COUNT).setVerbose(false).build();

        //Adding InterQJournalProtocolPB to server
        InterQJournalProtocolServerSideTranslatorPB qJournalProtocolServerSideTranslatorPB = new InterQJournalProtocolServerSideTranslatorPB(
                this);

        BlockingService interQJournalProtocolService = InterQJournalProtocolService.newReflectiveBlockingService(
    ...
    @Override
    public NewEpochResponseProto newEpoch(String journalId, String nameServiceId, NamespaceInfo nsInfo,
    ...
    @SuppressWarnings("deprecation")
    @Override
    public GetEditLogManifestResponseProto getEditLogManifest(String jid, String nameServiceId, long sinceTxId,
    ...
    @Override
    public GetJournaledEditsResponseProto getJournaledEdits(String jid, String nameServiceId, long sinceTxId,
    ...
    @Override
    public Boolean canRollBack(String journalId, String nameServiceId, StorageInfo storage, StorageInfo prevStorage,
    ...
    @SuppressWarnings("deprecation")
    @Override
    public GetEditLogManifestResponseProto getEditLogManifestFromJournal(String jid, String nameServiceId, long sinceTxId,
                                                                         boolean inProgressOk) throws IOException {
