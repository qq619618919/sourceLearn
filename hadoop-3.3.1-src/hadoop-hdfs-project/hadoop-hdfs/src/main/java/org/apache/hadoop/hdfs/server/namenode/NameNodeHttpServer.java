...
public class NameNodeHttpServer {
    ...
    public static void initWebHdfs(Configuration conf, String hostname, String httpKeytab, HttpServer2 httpServer2,
        ...
        if (conf.getBoolean(DFS_WEBHDFS_REST_CSRF_ENABLED_KEY, DFS_WEBHDFS_REST_CSRF_ENABLED_DEFAULT)) {
            ...
            HttpServer2.defineFilter(httpServer2.getWebAppContext(), restCsrfClassName, restCsrfClassName, restCsrfParams,
                    new String[]{pathSpec}
            );
        }
        ...
        httpServer2.addJerseyResourcePackage(jerseyResourcePackage + ";" + Param.class.getPackage().getName(), pathSpec,
                params
        );
    }
    ...
    private static void setupServlets(HttpServer2 httpServer) {
        ...
        httpServer.addInternalServlet(IsNameNodeActiveServlet.SERVLET_NAME, IsNameNodeActiveServlet.PATH_SPEC,
                IsNameNodeActiveServlet.class
        );
        httpServer.addInternalServlet("topology", NetworkTopologyServlet.PATH_SPEC, NetworkTopologyServlet.class);
    }
