...
public class StorageInfo {
    ...
    // TODO_MA 马中华 注释： 存储系统布局版本号， 当节点存储的目录结构发生改变或者 fsimage 和 editlog 的格式发生改变时，
    // TODO_MA 马中华 注释： 存储系统布局版本号会更新。 这个版本号一般是负数。
    public int layoutVersion;   // layout version of the storage data

    // TODO_MA 马中华 注释：  存储系统命名空间标识。
    public int namespaceID;     // id of the file system

    // TODO_MA 马中华 注释： 存储系统的集群ID。
    public String clusterID;      // id of the cluster

    // TODO_MA 马中华 注释： 存储系统创建时间。
    public long cTime;           // creation time of the file system state

    // TODO_MA 马中华 注释： 节点类型， 有DATA_NODE、 NAME_NODE、 JOURNAL_NODE等类型。
    ...
    protected void setLayoutVersion(Properties props,
                                    StorageDirectory sd) throws IncorrectVersionException, InconsistentFSStateException {
