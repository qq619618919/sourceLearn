...
public class BackupNode extends NameNode {
    ...
    protected void loadNamesystem(Configuration conf) throws IOException {
        // TODO_MA 马中华 注释： dfs.namenode.safemode.threshold-pct = 1.5f
        conf.setFloat(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, BN_SAFEMODE_THRESHOLD_PCT_DEFAULT);
        // TODO_MA 马中华 注释： dfs.namenode.safemode.extension = Integer.MAX_VALUE
    ...
    private NamespaceInfo handshake(Configuration conf) throws IOException {
        ...
        this.namenode = NameNodeProxies.createNonHAProxy(conf, nnAddress, NamenodeProtocol.class, UserGroupInformation.getCurrentUser(), true)
                .getProxy();
