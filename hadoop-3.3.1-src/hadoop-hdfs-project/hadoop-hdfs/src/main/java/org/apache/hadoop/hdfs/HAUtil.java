...
public class HAUtil {
    ...
    public static boolean isHAEnabled(Configuration conf, String nsId) {
        ...
        // TODO_MA 马中华 注释： 获取 namenode 的地址集合
         ...
         *  注释： 如果配置的 namenode 的个数 大于 1 则表示配置了 HA
         */
    ...
    public static String getNameNodeId(Configuration conf, String nsId) {
        ...
        // TODO_MA 马中华 注释： 获取 NameServiceId 和 NameNodeID 中的第二个返回
        return suffixes[1];
    }
    ...
    public static boolean shouldAllowStandbyReads(Configuration conf) {
        ...
        // TODO_MA 马中华 注释： dfs.ha.allow.stale.reads = false
