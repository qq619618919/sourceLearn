...
public abstract class INode implements INodeAttributes, Diff.Element<byte[]> {
     ...
     */
    public abstract QuotaCounts computeQuotaUsage(BlockStoragePolicySuite bsps, byte blockStoragePolicyId, boolean useCache,
                                                  int lastSnapshotId);
    ...
    public static class ReclaimContext {
         ...
         */
        public ReclaimContext(BlockStoragePolicySuite bsps, BlocksMapUpdateInfo collectedBlocks, List<INode> removedINodes,
