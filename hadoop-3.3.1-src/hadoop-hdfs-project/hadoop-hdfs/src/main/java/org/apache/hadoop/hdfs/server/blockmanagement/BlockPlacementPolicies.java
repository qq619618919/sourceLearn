...
public class BlockPlacementPolicies {
    ...
    public BlockPlacementPolicies(Configuration conf, FSClusterStats stats, NetworkTopology clusterMap,
                                  Host2NodesMap host2datanodeMap) {

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： dfs.block.replicator.classname = BlockPlacementPolicyDefault
         */
        ...
        // TODO_MA 马中华 注释： 通过反射创建实例，并且执行初始化
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： dfs.block.placement.ec.classname = BlockPlacementPolicyRackFaultTolerant
         */
        final Class<? extends BlockPlacementPolicy> blockPlacementECClass = conf.getClass(
                DFSConfigKeys.DFS_BLOCK_PLACEMENT_EC_CLASSNAME_KEY, DFSConfigKeys.DFS_BLOCK_PLACEMENT_EC_CLASSNAME_DEFAULT,
                BlockPlacementPolicy.class
        );
