...
public class NameNodeRpcServer implements NamenodeProtocols {
    ...
    public NameNodeRpcServer(Configuration conf, NameNode nn) throws IOException {
        ...
        // TODO_MA 马中华 注释： DatanodeProtocol
        ...
        // TODO_MA 马中华 注释： DatanodeLifelineProtocol
        DatanodeLifelineProtocolServerSideTranslatorPB lifelineProtoPbTranslator = new DatanodeLifelineProtocolServerSideTranslatorPB(
                this);
        BlockingService lifelineProtoPbService = DatanodeLifelineProtocolService.newReflectiveBlockingService(
                lifelineProtoPbTranslator);

        // TODO_MA 马中华 注释： NamenodeProtocol
        ...
        // TODO_MA 马中华 注释： RefreshAuthorizationPolicyProtocol
        RefreshAuthorizationPolicyProtocolServerSideTranslatorPB refreshAuthPolicyXlator = new RefreshAuthorizationPolicyProtocolServerSideTranslatorPB(
                this);
        BlockingService refreshAuthService = RefreshAuthorizationPolicyProtocolService.newReflectiveBlockingService(
                refreshAuthPolicyXlator);

        // TODO_MA 马中华 注释： RefreshUserMappingsProtocol
        RefreshUserMappingsProtocolServerSideTranslatorPB refreshUserMappingXlator = new RefreshUserMappingsProtocolServerSideTranslatorPB(
                this);
        BlockingService refreshUserMappingService = RefreshUserMappingsProtocolService.newReflectiveBlockingService(
                refreshUserMappingXlator);

        // TODO_MA 马中华 注释： RefreshCallQueueProtocol
        ...
        BlockingService refreshCallQueueService = RefreshCallQueueProtocolService.newReflectiveBlockingService(
                refreshCallQueueXlator);

        // TODO_MA 马中华 注释： GenericRefreshProtocol
        ...
        // TODO_MA 马中华 注释： GetUserMappingsProtocol
        ...
        // TODO_MA 马中华 注释： HAServiceProtocol
        ...
        // TODO_MA 马中华 注释： ReconfigurationProtocol
        ReconfigurationProtocolServerSideTranslatorPB reconfigurationProtocolXlator = new ReconfigurationProtocolServerSideTranslatorPB(
                this);
        BlockingService reconfigurationPbService = ReconfigurationProtocolService.newReflectiveBlockingService(
                reconfigurationProtocolXlator);

        // TODO_MA 马中华 注释： TraceAdminProtocol
         ...
         *  注释： NameNode 地址：0.0.0.0:8020
         *  可以通过 dfs.namenode.servicerpc-address 进行配置
         */
        InetSocketAddress serviceRpcAddr = nn.getServiceRpcServerAddress(conf);
        if (serviceRpcAddr != null) {
            // TODO_MA 马中华 注释： 端口 = dfs.namenode.servicerpc-bind-host = 8020
            ...
            /*************************************************
             * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
             *  注释： NameNode 和 Client 的通信服务端
             *  具体实现：ClientNamenodeProtocolPB
             */
            serviceRpcServer = new RPC.Builder(conf).setProtocol(org.apache.hadoop.hdfs.protocolPB.ClientNamenodeProtocolPB.class)
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： dfs.namenode.lifeline.rpc-address 默认没有配置，不启动
         *  如果你想找到这个参数的值： 去默认配置文件中： hdfs-default.xml
         *  如果要配置，则到 hdfs-site.xml 文件中，执行配置，或者要修改默认值，也是到 hdfs-site.xml
         *  代码中设置 > hdfs-site.xml > hdfs-default.xml
         *  四个模块，四个配置文件：
         *  1、common:  core-site.xml     core-default.xml
         *  2、hdfs  hdfs-site.xml
         *  3、yarn   yarn-site.xml
         *  4、mapreduce:  mapred-site.xml
         */
        ...
        if (lifelineRpcAddr != null) {
            ...
            // TODO_MA 马中华 注释： dfs.namenode.lifeline.rpc-bind-host
            ...
            // TODO_MA 马中华 注释： dfs.namenode.lifeline.handler.count
            int lifelineHandlerCount = conf.getInt(DFS_NAMENODE_LIFELINE_HANDLER_COUNT_KEY, 0);
            if (lifelineHandlerCount <= 0) {
                float lifelineHandlerRatio = conf.getFloat(DFS_NAMENODE_LIFELINE_HANDLER_RATIO_KEY,
             ...
             *  注释： HA 通信服务
             */
            lifelineRpcServer = new RPC.Builder(conf).setProtocol(HAServiceProtocolPB.class).setInstance(haPbService)
                    .setBindAddress(bindHost).setPort(lifelineRpcAddr.getPort()).setNumHandlers(lifelineHandlerCount)
                    .setVerbose(false).setSecretManager(namesystem.getDelegationTokenSecretManager()).build();
        ...
        boolean enableStateContext = conf.getBoolean(DFS_NAMENODE_STATE_CONTEXT_ENABLED_KEY,
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 通信协议： ClientNamenodeProtocolPB
         */
        clientRpcServer = new RPC.Builder(conf).setProtocol(org.apache.hadoop.hdfs.protocolPB.ClientNamenodeProtocolPB.class)
                .setInstance(clientNNPbService).setBindAddress(bindHost).setPort(rpcAddr.getPort()).setNumHandlers(handlerCount)
                .setVerbose(false).setSecretManager(namesystem.getDelegationTokenSecretManager())
                .setAlignmentContext(stateIdContext).build();
        ...
        defaultECPolicyName = conf.getTrimmed(DFSConfigKeys.DFS_NAMENODE_EC_SYSTEM_DEFAULT_POLICY,
                DFSConfigKeys.DFS_NAMENODE_EC_SYSTEM_DEFAULT_POLICY_DEFAULT
        );

        // Set terse exception whose stack trace won't be logged
        clientRpcServer.addTerseExceptions(SafeModeException.class, FileNotFoundException.class,
                ...
                QuotaExceededException.class, RecoveryInProgressException.class, AccessControlException.class, InvalidToken.class,
                LeaseExpiredException.class, NSQuotaExceededException.class, DSQuotaExceededException.class,
                QuotaByStorageTypeExceededException.class, AclException.class, FSLimitException.PathComponentTooLongException.class,
                FSLimitException.MaxDirectoryItemsExceededException.class, DisallowedDatanodeException.class
        );
    ...
    public HdfsFileStatus create(String src, FsPermission masked, String clientName, EnumSetWritable<CreateFlag> flag,
        ...
        try {
             ...
             * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
             *  注释： 到底如何完成文件创建？
             *  1、解析 要创建的文件的路径，得知这个文件，是在那个 文件夹下，然后判断该文件夹是否存在
             *  2、生成一个 INodeFile 对象
             *  3、把 INodeFile 这个对象，添加到 父文件夹下的 子节点列表中
             */
            status = namesystem.startFile(src, perm, clientName, clientMachine, flag.get(), createParent, replication, blockSize,
                    supportedVersions, ecPolicyName, storagePolicy, cacheEntry != null
            );
        } finally {
    ...
    public LocatedBlock addBlock(String src, String clientName, ExtendedBlock previous, DatanodeInfo[] excludedNodes, long fileId,
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： NameNode 中调用 FSNamesystem 来处理 Block 申请请求
         *  大致可以分为 三 步：
         *  1、根据副本存放策略选择合适的 datanode 列表
         *  2、将 Block 对象加入文件对应的 INodeFile 对象中，并且记录日志
         *  3、构建 LocatedBlock 对象返回
         */
        LocatedBlock locatedBlock = namesystem.getAdditionalBlock(src, fileId, clientName, previous, excludedNodes, favoredNodes,
                addBlockFlags
        );
    ...
    public LocatedBlock getAdditionalDatanode(final String src, final long fileId, final ExtendedBlock blk,
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("getAdditionalDatanode: src=" + src + ", fileId=" + fileId + ", blk=" + blk + ", existings=" + Arrays.asList(
                    existings) + ", excludes=" + Arrays.asList(
         ...
         *  注释：
         */
        LocatedBlock locatedBlock = namesystem.getAdditionalDatanode(src, fileId, blk, existings, existingStorageIDs, excludeSet,
    ...
    public void commitBlockSynchronization(ExtendedBlock block, long newgenerationstamp, long newlength, boolean closeFile,
    ...
    public boolean rename(String src, String dst) throws IOException {
        ...
        if (!checkPathLength(dst)) {
            throw new IOException(
                    "rename: Pathname too long.  Limit " + MAX_PATH_LENGTH + " characters, " + MAX_PATH_DEPTH + " levels.");
        }
        namesystem.checkOperation(OperationCategory.WRITE);
        CacheEntry cacheEntry = RetryCache.waitForCompletion(retryCache);
        if (cacheEntry != null && cacheEntry.isSuccess()) {
    ...
    // TODO_MA 马中华 注释： NameNode 包含两大重要组件：NameNodeRpcServer + FSNameSystem
    @Override // ClientProtocol
    public boolean mkdirs(String src, FsPermission masked, boolean createParent) throws IOException {
        ...
        if (!checkPathLength(src)) {
            throw new IOException(
                    "mkdirs: Pathname too long.  Limit " + MAX_PATH_LENGTH + " characters, " + MAX_PATH_DEPTH + " levels.");
        }

        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： NameNode 接收到 创建文件夹的 RPC 请求调用 FSNamesystem 来执行处理
         */
    ...
    @Override // ClientProtocol
    public BatchedEntries<OpenFileEntry> listOpenFiles(long prevId, EnumSet<OpenFilesType> openFilesTypes,
    ...
    public void setBalancerBandwidth(long bandwidth) throws IOException {
        if (bandwidth > HdfsServerConstants.MAX_BANDWIDTH_PER_DATANODE) {
            throw new IllegalArgumentException(
                    "Bandwidth should not exceed maximum limit " + HdfsServerConstants.MAX_BANDWIDTH_PER_DATANODE + " bytes per second");
        }
        checkNNStartup();
    ...
    public DatanodeRegistration registerDatanode(DatanodeRegistration nodeReg) throws IOException {
        ...
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： FSNameSystem 来处理 DataNode 的心跳
         */
        namesystem.registerDatanode(nodeReg);

        // TODO_MA 马中华 注释： 返回注册对象，给 DataNode
        return nodeReg;
    }
    ...
    public HeartbeatResponse sendHeartbeat(DatanodeRegistration nodeReg, StorageReport[] report, long dnCacheCapacity,
        ...
        return namesystem.handleHeartbeat(nodeReg, report, dnCacheCapacity, dnCacheUsed, xceiverCount, xmitsInProgress,
                failedVolumes, volumeFailureSummary, requestFullBlockReportLease, slowPeers, slowDisks
        );
    }
     ...
     */
    @Override // DatanodeProtocol
    public DatanodeCommand blockReport(final DatanodeRegistration nodeReg, String poolId, final StorageBlockReport[] reports,
        ...
        try {
            if (bm.checkBlockReportLease(context, nodeReg)) {
                for (int r = 0; r < reports.length; r++) {
                    ...
                    /*************************************************
                     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
                     *  注释： 通过 BlockManager 内部的 BlockReportProcessingThread 来完成任务的执行
                     *  提交一个任务到 BlockManager 内部的一个 blockReportThread 线程的内部队列 queue 中。
                     */
    ...
    /*************************************************
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释：  将短时间内接收的副本或者删除的副本增量汇报给 Namenode
     */
    @Override // DatanodeProtocol
    public void blockReceivedAndDeleted(final DatanodeRegistration nodeReg, String poolId,
        ...
        if (blockStateChangeLog.isDebugEnabled()) {
            blockStateChangeLog.debug(
                    "*BLOCK* NameNode.blockReceivedAndDeleted: " + "from " + nodeReg + " " + receivedAndDeletedBlocks.length + " blocks.");
        }
        final BlockManager bm = namesystem.getBlockManager();
                ...
                public void run() {
                    try {
                        ...
                        blockStateChangeLog.error(
                                "*BLOCK* NameNode.blockReceivedAndDeleted: " + "failed from " + nodeReg + ": " + ex.getMessage());
                    }
                }
            });
        }
    ...
    public void sendLifeline(DatanodeRegistration nodeReg, StorageReport[] report, long dnCacheCapacity, long dnCacheUsed,
                             int xmitsInProgress, int xceiverCount, int failedVolumes,
                             VolumeFailureSummary volumeFailureSummary) throws IOException {
        checkNNStartup();
        verifyRequest(nodeReg);
        namesystem.handleLifeline(nodeReg, report, dnCacheCapacity, dnCacheUsed, xceiverCount, xmitsInProgress, failedVolumes,
    ...
    private void verifyRequest(NodeRegistration nodeReg) throws IOException {
        ...
        if (!expectedID.equals(id)) {
            LOG.warn("Registration IDs mismatched: the " + nodeReg.getClass()
                    .getSimpleName() + " ID is " + id + " but the expected ID is " + expectedID);
    ...
    public synchronized void transitionToActive(
            StateChangeRequestInfo req) throws ServiceFailedException, AccessControlException, IOException {
        checkNNStartup();
    ...
    public synchronized void transitionToStandby(
        ...
        if (nn.getState().equals(NameNode.OBSERVER_STATE.toString()) && req.getSource() == RequestSource.REQUEST_BY_ZKFC) {
            throw new AccessControlException(
                    "Request from ZK failover controller at " + Server.getRemoteAddress() + " denied since the namenode is in Observer state.");
        }
        nn.checkHaStateChange(req);
        /*************************************************
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： NameNode 切换自己的状态为 active
         */
        ...
        if (!dnVersion.equals(nnVersion)) {
            ...
            if (nnCTime != dnCTime) {
                IncorrectVersionException ive = new IncorrectVersionException(
                        messagePrefix + " and CTime of DN ('" + dnCTime + "') does not match CTime of NN ('" + nnCTime + "')");
    ...
    public String createSnapshot(String snapshotRoot, String snapshotName) throws IOException {
        ...
        if (!checkPathLength(snapshotRoot)) {
            throw new IOException(
                    "createSnapshot: Pathname too long.  Limit " + MAX_PATH_LENGTH + " characters, " + MAX_PATH_DEPTH + " levels.");
        }
        namesystem.checkOperation(OperationCategory.WRITE);
        CacheEntryWithPayload cacheEntry = RetryCache.waitForCompletion(retryCache, null);
        if (cacheEntry != null && cacheEntry.isSuccess()) {
    ...
    @Override // ClientProtocol
    public SnapshotDiffReportListing getSnapshotDiffReportListing(String snapshotRoot, String earlierSnapshotName,
                                                                  String laterSnapshotName, byte[] startPath,
                                                                  int index) throws IOException {
        checkNNStartup();
        SnapshotDiffReportListing report = namesystem.getSnapshotDiffReportListing(snapshotRoot, earlierSnapshotName,
    ...
    public EventBatchList getEditsFromTxid(long txid) throws IOException {
        ...
        namesystem.checkOperation(OperationCategory.READ); // only active
        namesystem.checkSuperuserPrivilege();
        int maxEventsPerRPC = nn.getConf().getInt(DFSConfigKeys.DFS_NAMENODE_INOTIFY_MAX_EVENTS_PER_RPC_KEY,
    ...
    private EventBatchList getEventBatchList(long syncTxid, long txid, FSEditLog log, boolean readInProgress,
                                             int maxEventsPerRPC) throws IOException {
    ...
    public Long getNextSPSPath() throws IOException {
        ...
        if (spsMode != StoragePolicySatisfierMode.EXTERNAL) {
            ...
            throw new IOException(
                    "SPS service mode is " + spsMode + ", so " + "external SPS service is not allowed to fetch the path Ids");
        }
