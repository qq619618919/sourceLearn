...
public class NameNodeResourceChecker {
    ...
    class CheckedVolume implements CheckableNameNodeResource {
        ...
        public boolean isResourceAvailable() {
            ...
            // TODO_MA 马中华 注释： 如果可用大小小于 100M 了，则不可用
            if (availableSpace < duReserved) {
                LOG.warn(
                        "Space available on volume '" + volume + "' is " + availableSpace + ", which is below the configured reserved amount " + duReserved);
                return false;
            } else {
                return true;
            }
    ...
    public NameNodeResourceChecker(Configuration conf) throws IOException {
        ...
        // TODO_MA 马中华 注释： dfs.namenode.resource.du.reserved = 100M
        ...
        // TODO_MA 马中华 注释： dfs.namenode.shared.edits.dir 或者 dfs.namenode.name.dir
        ...
        // TODO_MA 马中华 注释： dfs.namenode.resource.checked.volumes.minimum = 1
