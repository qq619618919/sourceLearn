...
public class EncryptionZoneManager {
    ...
    private static class EncryptionZoneInt {
        ...
        public boolean equals(Object o) {
            ...
            return new EqualsBuilder().append(inodeId, b.getINodeId()).append(suite, b.getSuite()).append(version, b.getVersion())
                    .append(keyName, b.getKeyName()).isEquals();
        }
    ...
    public static final BatchedListEntries<ZoneReencryptionStatus> EMPTY_LIST = new BatchedListEntries<>(new ArrayList<ZoneReencryptionStatus>(),
            false);
    ...
    public EncryptionZoneManager(FSDirectory dir, Configuration conf) {
        ...
        maxListRecncryptionStatusResponses = conf.getInt(DFS_NAMENODE_LIST_REENCRYPTION_STATUS_NUM_RESPONSES_KEY,
            ...
            if (snapshotID == Snapshot.CURRENT_STATE_ID) {
                ...
                if (xAttr != null) {
                    try {
                        ...
                        return new EncryptionZoneInt(inode.getId(), PBHelperClient.convert(ezProto.getSuite()),
    ...
    void checkMoveValidity(INodesInPath srcIIP, INodesInPath dstIIP) throws IOException {
        ...
        if (srcInEZ) {
            if (!srcParentEZI.equals(dstParentEZI)) {
                ...
                sb.append(" can't be moved from encryption zone ").append(srcEZPath).append(" to encryption zone ").append(dstEZPath)
                        .append(".");
     ...
     */
    private boolean pathResolvesToId(final long zoneId,
                                     final String zonePath) throws UnresolvedLinkException, AccessControlException, ParentNotDirectoryException {
        assert dir.hasReadLock();
