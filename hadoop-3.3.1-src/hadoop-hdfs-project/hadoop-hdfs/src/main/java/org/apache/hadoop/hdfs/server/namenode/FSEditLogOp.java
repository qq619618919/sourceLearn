...
public abstract class FSEditLogOp {
    ...
    private static final class AclEditLogUtil {
        ...
        private static List<AclEntry> read(DataInputStream in, int logVersion) throws IOException {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                aclEntries.add(new AclEntry.Builder().setName(name).setPermission(FSACTION_VALUES[p]).setScope(ACL_ENTRY_SCOPE_VALUES[s])
        ...
        private static void write(List<AclEntry> aclEntries, DataOutputStream out) throws IOException {
            ...
            for (AclEntry e : aclEntries) {
                ...
                int v = (e.getScope().ordinal() << ACL_EDITLOG_ENTRY_SCOPE_OFFSET) | (e.getType()
                        .ordinal() << ACL_EDITLOG_ENTRY_TYPE_OFFSET) | e.getPermission().ordinal();
    ...
    static abstract class AddCloseOp extends FSEditLogOp implements BlockListUpdatingOp {
        ...
        void readFields(DataInputStream in, int logVersion) throws IOException {
            ...
            if ((-17 < logVersion && length != 4) || (logVersion <= -17 && length != 5 && !NameNodeLayoutVersion.supports(
        ...
        public String stringifyMembers() {
            ...
            builder.append("[length=").append(length).append(", inodeId=").append(inodeId).append(", path=").append(path)
                    .append(", replication=").append(replication).append(", mtime=").append(mtime).append(", atime=").append(atime)
                    .append(", blockSize=").append(blockSize).append(", blocks=").append(Arrays.toString(blocks)).append(", permissions=")
                    .append(permissions).append(", aclEntries=").append(aclEntries).append(", clientName=").append(clientName)
                    .append(", clientMachine=").append(clientMachine).append(", overwrite=").append(overwrite);
            if (this.opCode == OP_ADD) {
                appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            }
            builder.append(", storagePolicyId=").append(storagePolicyId).append(", erasureCodingPolicyId=").append(erasureCodingPolicyId)
                    .append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
    ...
    static class AppendOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AppendOp ").append("[path=").append(path).append(", clientName=").append(clientName).append(", clientMachine=")
                    .append(clientMachine).append(", newBlock=").append(newBlock).append("]");
            return builder.toString();
        }
    ...
    static class AddBlockOp extends FSEditLogOp {
        ...
        public String toString() {
            ...
            sb.append("AddBlockOp [path=").append(path).append(", penultimateBlock=")
                    .append(penultimateBlock == null ? "NULL" : penultimateBlock).append(", lastBlock=").append(lastBlock);
    ...
    static class SetReplicationOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetReplicationOp [path=").append(path).append(", replication=").append(replication).append(", opCode=")
                    .append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class ConcatDeleteOp extends FSEditLogOp {
        ...
        void readFields(DataInputStream in, int logVersion) throws IOException {
            ...
            if (srcSize < 0) {
                ...
                throw new IOException(
                        "Incorrect data format. " + "ConcatDeleteOp can have at most " + MAX_CONCAT_SRC + " sources, but we tried to have " + (length - 3) + " sources.");
            }
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("ConcatDeleteOp [length=").append(length).append(", trg=").append(trg).append(", srcs=").append(Arrays.toString(srcs))
    ...
    static class RenameOldOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenameOldOp [length=").append(length).append(", src=").append(src).append(", dst=").append(dst)
                    .append(", timestamp=").append(timestamp);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
    ...
    static class MkdirOp extends FSEditLogOp {
        ...
        void readFields(DataInputStream in, int logVersion) throws IOException {
            ...
            if (-17 < logVersion && length != 2 || logVersion <= -17 && length != 3 && !NameNodeLayoutVersion.supports(
                    LayoutVersion.Feature.EDITLOG_OP_OPTIMIZATION, logVersion)) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("MkdirOp [length=").append(length).append(", inodeId=").append(inodeId).append(", path=").append(path)
                    .append(", timestamp=").append(timestamp).append(", permissions=").append(permissions).append(", aclEntries=")
                    .append(aclEntries).append(", opCode=").append(opCode).append(", txid=").append(txid).append(", xAttrs=").append(xAttrs)
                    .append("]");
            return builder.toString();
        }
    ...
    static class SetGenstampV1Op extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetGenstampOp [GenStamp=").append(genStampV1).append(", opCode=").append(opCode).append(", txid=").append(txid)
                    .append("]");
            return builder.toString();
        }
    ...
    static class SetGenstampV2Op extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetGenstampV2Op [GenStampV2=").append(genStampV2).append(", opCode=").append(opCode).append(", txid=").append(txid)
                    .append("]");
            return builder.toString();
        }
    ...
    static class AllocateBlockIdOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AllocateBlockIdOp [blockId=").append(blockId).append(", opCode=").append(opCode).append(", txid=").append(txid)
                    .append("]");
            return builder.toString();
        }
    ...
    static class SetPermissionsOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetPermissionsOp [src=").append(src).append(", permissions=").append(permissions).append(", opCode=").append(opCode)
    ...
    static class SetOwnerOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetOwnerOp [src=").append(src).append(", username=").append(username).append(", groupname=").append(groupname)
                    .append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetNSQuotaOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetNSQuotaOp [src=").append(src).append(", nsQuota=").append(nsQuota).append(", opCode=").append(opCode)
                    .append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetQuotaOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetQuotaOp [src=").append(src).append(", nsQuota=").append(nsQuota).append(", dsQuota=").append(dsQuota)
                    .append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetQuotaByStorageTypeOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetTypeQuotaOp [src=").append(src).append(", storageType=").append(type).append(", dsQuota=").append(dsQuota)
                    .append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class TimesOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("TimesOp [length=").append(length).append(", path=").append(path).append(", mtime=").append(mtime).append(", atime=")
                    .append(atime).append(", opCode=").append(opCode).append(", txid=").append(txid);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class SymlinkOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SymlinkOp [length=").append(length).append(", inodeId=").append(inodeId).append(", path=").append(path)
                    .append(", value=").append(value).append(", mtime=").append(mtime).append(", atime=").append(atime)
                    .append(", permissionStatus=").append(permissionStatus);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class RenameOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenameOp [length=").append(length).append(", src=").append(src).append(", dst=").append(dst).append(", timestamp=")
                    .append(timestamp).append(", options=").append(Arrays.toString(options));
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class TruncateOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("TruncateOp [src=").append(src).append(", clientName=").append(clientName).append(", clientMachine=")
                    .append(clientMachine).append(", newLength=").append(newLength).append(", timestamp=").append(timestamp)
                    .append(", truncateBlock=").append(truncateBlock).append(", opCode=").append(opCode).append(", txid=").append(txid)
                    .append("]");
            return builder.toString();
        }
    }
    ...
    static class ReassignLeaseOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("ReassignLeaseOp [leaseHolder=").append(leaseHolder).append(", path=").append(path).append(", newHolder=")
                    .append(newHolder).append(", opCode=").append(opCode).append(", txid=").append(txid);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class GetDelegationTokenOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("GetDelegationTokenOp [token=").append(token).append(", expiryTime=").append(expiryTime).append(", opCode=")
                    .append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class RenewDelegationTokenOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenewDelegationTokenOp [token=").append(token).append(", expiryTime=").append(expiryTime).append(", opCode=")
                    .append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class CancelDelegationTokenOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("CancelDelegationTokenOp [token=").append(token).append(", opCode=").append(opCode).append(", txid=").append(txid)
                    .append("]");
            return builder.toString();
        }
    ...
    static class CreateSnapshotOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("CreateSnapshotOp [snapshotRoot=").append(snapshotRoot).append(", snapshotName=").append(snapshotName)
    ...
    static class DeleteSnapshotOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("DeleteSnapshotOp [snapshotRoot=").append(snapshotRoot).append(", snapshotName=").append(snapshotName)
                    .append(", mtime=").append(mtime);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
    ...
    static class RenameSnapshotOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenameSnapshotOp [snapshotRoot=").append(snapshotRoot).append(", snapshotOldName=").append(snapshotOldName)
                    .append(", snapshotNewName=").append(snapshotNewName).append(", mtime=").append(mtime);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class AddCacheDirectiveInfoOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AddCacheDirectiveInfo [").append("id=" + directive.getId() + ",")
                    .append("path=" + directive.getPath().toUri().getPath() + ",").append("replication=" + directive.getReplication() + ",")
                    .append("pool=" + directive.getPool() + ",").append("expiration=" + directive.getExpiration().getMillis());
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class AddCachePoolOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AddCachePoolOp [").append("poolName=" + info.getPoolName() + ",").append("ownerName=" + info.getOwnerName() + ",")
                    .append("groupName=" + info.getGroupName() + ",").append("mode=" + Short.toString(info.getMode().toShort()) + ",")
    ...
    static class SetStoragePolicyOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetStoragePolicyOp [path=").append(path).append(", policyId=").append(policyId).append(", opCode=").append(opCode)
                    .append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    public static class Writer {
        ...
        /**
         * // TODO_MA 马中华 注释： 将 Operation 写入到 output stream
        ...
        public void writeOp(FSEditLogOp op, int logVersion) throws IOException {
            ...
            // write the op code first to make padding and terminator verification work
    ...
    public abstract static class Reader {
        ...
        public static Reader create(DataInputStream in, StreamLimiter limiter, int logVersion) {
            if (logVersion < NameNodeLayoutVersion.CURRENT_LAYOUT_VERSION) {
                ...
                // scanOp on them.  This is important for the JournalNode during rolling upgrade.
        ...
        private long decodeOpFrame() throws IOException {
            ...
            if (expectedChecksum != calculatedChecksum) {
                throw new ChecksumException(
                        "Transaction is corrupt. Calculated checksum is " + calculatedChecksum + " but read checksum " + expectedChecksum, txid);
            }
            return txid;
        }
    }
    ...
    private static List<AclEntry> readAclEntriesFromXml(Stanza st) {
        ...
        for (Stanza s : stanzas) {
            AclEntry e = new AclEntry.Builder().setScope(AclEntryScope.valueOf(s.getValue("SCOPE")))
                    .setType(AclEntryType.valueOf(s.getValue("TYPE"))).setName(s.getValueOrNull("NAME")).setPermission(fsActionFromXml(s))
                    .build();
            aclEntries.add(e);
        }
        return aclEntries;
