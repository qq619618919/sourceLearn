...
public class ProvidedStorageMap {
    ...
    ProvidedStorageMap(RwLock lock, BlockManager bm, Configuration conf) throws IOException {
        ...
        providedEnabled = conf.getBoolean(DFSConfigKeys.DFS_NAMENODE_PROVIDED_ENABLED,
        ...
        Class<? extends BlockAliasMap> aliasMapClass = conf.getClass(DFSConfigKeys.DFS_PROVIDED_ALIASMAP_CLASS,
        ...
        LocatedBlock newLocatedBlock(ExtendedBlock eb, DatanodeStorageInfo[] storages, long pos, boolean isCorrupt) {
            ...
            for (int i = 0; i < storages.length; ++i) {
                ...
                if (StorageType.PROVIDED.equals(storageType)) {
                    ...
                    locs.add(new DatanodeInfoWithStorage(currInfo.getDatanodeDescriptor(), currInfo.getStorageID(),
                            storageType
                    ));
            ...
            return new LocatedBlock(eb, locs.toArray(new DatanodeInfoWithStorage[locs.size()]),
                    sids.toArray(new String[sids.size()]), types.toArray(new StorageType[types.size()]), pos, isCorrupt, null
            );
        }
    ...
    public static class ProvidedDescriptor extends DatanodeDescriptor {
        ...
        ProvidedDescriptor() {
            super(new DatanodeID(null,                         // String ipAddr,
