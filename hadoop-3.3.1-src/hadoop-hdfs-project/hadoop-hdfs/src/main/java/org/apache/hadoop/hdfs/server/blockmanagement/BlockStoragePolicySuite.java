...
public class BlockStoragePolicySuite {
    ...
    public static BlockStoragePolicySuite createDefaultSuite() {
        ...
        policies[allssdId] = new BlockStoragePolicy(allssdId, HdfsConstants.ALLSSD_STORAGE_POLICY_NAME,
                new StorageType[]{StorageType.SSD}, new StorageType[]{StorageType.DISK}, new StorageType[]{StorageType.DISK}
        );
        ...
        policies[hotId] = new BlockStoragePolicy(hotId, HdfsConstants.HOT_STORAGE_POLICY_NAME,
                new StorageType[]{StorageType.DISK}, StorageType.EMPTY_ARRAY, new StorageType[]{StorageType.ARCHIVE}
        );
        ...
        policies[providedId] = new BlockStoragePolicy(providedId, HdfsConstants.PROVIDED_STORAGE_POLICY_NAME,
