...
public interface FsDatasetSpi<V extends FsVolumeSpi> extends FSDatasetMBean {
    ...
    abstract class Factory<D extends FsDatasetSpi<?>> {
        ...
        public static Factory<?> getFactory(Configuration conf) {
            @SuppressWarnings("rawtypes") final Class<? extends Factory> clazz = conf.getClass(
                    DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY, FsDatasetFactory.class, Factory.class);
     ...
     */
    ReplicaHandler createTemporary(StorageType storageType, String storageId, ExtendedBlock b,
     ...
     * @throws IOException if an error occurs
     */
    ReplicaHandler createRbw(StorageType storageType, String storageId, ExtendedBlock b,
     ...
     */
    void checkBlock(ExtendedBlock b, long minLength,
     ...
     */
    Replica updateReplicaUnderRecovery(ExtendedBlock oldBlock, long recoveryId, long newBlockId,
     ...
     */
    void submitBackgroundSyncFileRangeRequest(final ExtendedBlock block, final ReplicaOutputStreams outs, final long offset,
     ...
     */
    ReplicaInfo moveBlockAcrossStorage(final ExtendedBlock block, StorageType targetStorageType,
