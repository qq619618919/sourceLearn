...
public class TestExternalBlockReader {
    ...
    private static final HashMap<String, LinkedList<SyntheticReplicaAccessor>> accessors = new HashMap<String, LinkedList<SyntheticReplicaAccessor>>(
            1);
    ...
    public static class SyntheticReplicaAccessorBuilder extends ReplicaAccessorBuilder {
        ...
        public ReplicaAccessor build() {
            if (visibleLength < 1024) {
                LOG.info(
                        "SyntheticReplicaAccessorFactory returning null for a " + "smaller replica with size " + visibleLength); //trace
                return null;
            }
