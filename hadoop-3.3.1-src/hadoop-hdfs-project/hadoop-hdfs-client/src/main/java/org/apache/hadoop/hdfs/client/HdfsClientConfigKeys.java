...
public interface HdfsClientConfigKeys {
    ...
    String DFS_CLIENT_READ_USE_CACHE_PRIORITY = "dfs.client.read.use.cache.priority";
    ...
    String DFS_CLIENT_DEAD_NODE_DETECTION_IDLE_SLEEP_MS_KEY = "dfs.client.deadnode.detection.idle.sleep.ms";
    ...
    long DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_INTERVAL_MS_DEFAULT = 60 * 1000; // 60s
    ...
    long DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_INTERVAL_MS_DEFAULT = 300; // 300ms
    ...
    interface BlockWrite {
        // TODO_MA 马中华 注释： dfs.client.block.write.
        String PREFIX = HdfsClientConfigKeys.PREFIX + "block.write.";
        // TODO_MA 马中华 注释： dfs.client.block.write.retries
