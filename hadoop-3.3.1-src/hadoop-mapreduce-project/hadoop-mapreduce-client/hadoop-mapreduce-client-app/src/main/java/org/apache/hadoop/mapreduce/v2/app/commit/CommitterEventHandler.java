...
public class CommitterEventHandler extends AbstractService implements EventHandler<CommitterEvent> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(CommitterEventHandler.class);
    ...
    protected void serviceInit(Configuration conf) throws Exception {
        ...
        commitThreadCancelTimeoutMs = conf.getInt(MRJobConfig.MR_AM_COMMITTER_CANCEL_TIMEOUT_MS,
    ...
    private class EventProcessor implements Runnable {
        ...
        public void run() {
            ...
            switch (event.getType()) {
                ...
                case TASK_ABORT:
                    ...
                    break;
                default:
                    throw new YarnRuntimeException("Unexpected committer event " + event.toString());
            }
        }
        ...
        protected void handleJobSetup(CommitterJobSetupEvent event) {
            try {
                ...
                context.getEventHandler().handle(new JobSetupFailedEvent(event.getJobID(), StringUtils.stringifyException(e)));
            }
        }
        ...
        protected void handleTaskAbort(CommitterTaskAbortEvent event) {
            ...
            context.getEventHandler().handle(new TaskAttemptEvent(event.getAttemptID(), TaskAttemptEventType.TA_CLEANUP_DONE));
        }
