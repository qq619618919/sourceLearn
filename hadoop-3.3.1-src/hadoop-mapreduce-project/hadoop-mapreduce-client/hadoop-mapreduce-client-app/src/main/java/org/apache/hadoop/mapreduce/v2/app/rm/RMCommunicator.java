...
public abstract class RMCommunicator extends AbstractService implements RMHeartbeatHandler {
    ...
    protected void serviceInit(Configuration conf) throws Exception {
        ...
        // TODO_MA 马中华 注释： yarn.app.mapreduce.am.scheduler.heartbeat.interval-ms = 1000
    ...
    protected void serviceStart() throws Exception {
         ...
         *  注释： 创建 RM 代理
         *  ApplicatoinMaster 和 RM 之间通信协议： ApplicationMasterProtocol
         */
    ...
    protected void register() {
        ...
        try {
            ...
            if (serviceAddr != null) {
                ...
                request.setTrackingUrl(MRWebAppUtil.getAMWebappScheme(
                        getConfig()) + serviceAddr.getHostName() + ":" + clientService.getHttpPort());
            }
        ...
        public void run() {
            ...
            while (!stopped.get() && !Thread.currentThread().isInterrupted()) {
                try {
                    /*************************************************
                     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
                     *  注释： yarn.app.mapreduce.am.scheduler.heartbeat.interval-ms = 1000
                     */
                    Thread.sleep(rmPollInterval);
                    try {
                        /*************************************************
