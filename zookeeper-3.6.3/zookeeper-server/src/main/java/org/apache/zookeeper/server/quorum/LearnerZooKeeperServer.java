...
public abstract class LearnerZooKeeperServer extends QuorumZooKeeperServer {
    ...
    public LearnerZooKeeperServer(FileTxnSnapLog logFactory, int tickTime, int minSessionTimeout, int maxSessionTimeout,
            int listenBacklog, ZKDatabase zkDb, QuorumPeer self) throws IOException {
    ...
    public void createSessionTracker() {
         ...
         *  注释：
         */
        sessionTracker = new LearnerSessionTracker(this, getZKDatabase().getSessionWithTimeOuts(), this.tickTime,
