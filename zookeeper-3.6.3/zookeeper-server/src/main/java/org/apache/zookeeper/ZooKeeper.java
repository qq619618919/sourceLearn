...
public class ZooKeeper implements AutoCloseable {
    ...
    static class ZKWatchManager implements ClientWatchManager {
        ...
        // TODO_MA 马中华 注释： 监听 节点数据变化 的监听集合
        private final Map<String, Set<Watcher>> dataWatches = new HashMap<String, Set<Watcher>>();
        // TODO_MA 马中华 注释： 监听 节点存在与否状态 的监听集合
        private final Map<String, Set<Watcher>> existWatches = new HashMap<String, Set<Watcher>>();
        // TODO_MA 马中华 注释： 监听 子节点列表变化的 监听集合
        ...
        public Map<EventType, Set<Watcher>> removeWatcher(String clientPath, Watcher watcher, WatcherType watcherType,
                                                          boolean local, int rc) throws KeeperException {
            ...
            switch (watcherType) {
                ...
                case Data: {
                    ...
                    synchronized (existWatches) {
                        boolean removedDataWatcher = removeWatches(existWatches, watcher, clientPath, local, rc,
                                dataWatchersToRem);
                ...
                case Any: {
                    ...
                    synchronized (dataWatches) {
                        boolean removedDataWatcher = removeWatches(dataWatches, watcher, clientPath, local, rc,
                                dataWatchersToRem);
                        removedWatcher |= removedDataWatcher;
                    }
                    ...
                    synchronized (persistentWatches) {
                        boolean removedPersistentWatcher = removeWatches(persistentWatches, watcher, clientPath, local,
                                rc, persistentWatchersToRem);
                        removedWatcher |= removedPersistentWatcher;
                    }

                    synchronized (persistentRecursiveWatches) {
                        boolean removedPersistentRecursiveWatcher = removeWatches(persistentRecursiveWatches, watcher,
            ...
            switch (type) {
                ...
                default:
                    String errorMsg = String
                            .format("Unhandled watch event type %s with state %s on path %s", type, state, clientPath);
                    LOG.error(errorMsg);
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher, boolean canBeReadOnly,
         ...
         */
        cnxn = createConnection(connectStringParser.getChrootPath(), hostProvider, sessionTimeout, this, watchManager,
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher, long sessionId, byte[] sessionPasswd,
        ...
        LOG.info(
                "Initiating client connection, connectString={} " + "sessionTimeout={} watcher={} sessionId=0x{} sessionPasswd={}",
                connectString, sessionTimeout, watcher, Long.toHexString(sessionId),
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher, long sessionId, byte[] sessionPasswd,
                     boolean canBeReadOnly) throws IOException {
        this(connectString, sessionTimeout, watcher, sessionId, sessionPasswd, canBeReadOnly,
    ...
    public String create(final String path, byte[] data, List<ACL> acl,
        ...
        // TODO_MA 注释： 真正发送请求之前，封装请求对象，和响应对象
    ...
    protected void multiInternal(MultiOperationRecord request, MultiCallback cb,
     ...
     * @since 3.5.0
     */
    public void removeWatches(String path, Watcher watcher, WatcherType watcherType,
     ...
     * @since 3.6.0
     */
    public void addWatch(String basePath, Watcher watcher,
                         AddWatchMode mode) throws KeeperException, InterruptedException {
        ...
        ReplyHeader r = cnxn
                .submitRequest(h, request, new ErrorResponse(), new AddWatchRegistration(watcher, basePath, mode));
        if (r.getErr() != 0) {
    ...
    public void addWatch(String basePath, Watcher watcher, AddWatchMode mode, VoidCallback cb, Object ctx) {
        ...
        h.setType(ZooDefs.OpCode.addWatch);
        AddWatchRequest request = new AddWatchRequest(serverPath, mode.getMode());
        cnxn.queuePacket(h, new ReplyHeader(), request, new ErrorResponse(), cb, basePath, serverPath, ctx,
    ...
    public String toString() {
        ...
        return ("State:" + state.toString() + (state
                .isConnected() ? " Timeout:" + getSessionTimeout() + " " : " ") + cnxn);
    }
    ...
    private ClientCnxnSocket getClientCnxnSocket() throws IOException {
        ...
        // TODO_MA 注释： 通过 zookeeper.clientCnxnSocket 这个 key 配置具体的实现类
